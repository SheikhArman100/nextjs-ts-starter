...
export default plugin(({ addBase, theme }) => {
  ...
  addBase({
    '.demo1': {
      ...
      '--tw-sidebar-defualt-width': theme(
        'custom.layouts.demo1.sidebar.width.desktop',
      ),
      '--tw-header-height': theme('custom.layouts.demo1.header.height.desktop'),

      [`@media (max-width: ${theme('screens.lg')})`]: {
        '--tw-sidebar-width': theme(
          'custom.layouts.demo1.sidebar.width.mobile',
        ),
        '--tw-header-height': theme(
          'custom.layouts.demo1.header.height.mobile',
        ),
      },
    },
  });
    ...
    [`@media (min-width: ${theme('screens.lg')})`]: {
      '.demo1': {
        '.sidebar': {
          width: 'var(--tw-sidebar-width)',
          transition:
            'width var(--tw-sidebar-transition-duration) var(--tw-sidebar-transition-timing)',
          '.sidebar-header': {
            height: 'var(--tw-header-height)',
          },
          '.sidebar-wrapper': {
        ...
        '&.sidebar-fixed': {
          '.wrapper': {
            ...
            transition:
              'padding-left var(--tw-sidebar-transition-duration) var(--tw-sidebar-transition-timing)',
          },
          '&.header-fixed': {
            '.header': {
              left: 'var(--tw-sidebar-width)',
              transition:
                'left var(--tw-sidebar-transition-duration) var(--tw-sidebar-transition-timing)',
            },
            '.wrapper': {
              'padding-top': 'var(--tw-header-height)',
            },
        ...
        '&.sidebar-collapse': {
          '--tw-sidebar-width': theme(
            'custom.layouts.demo1.sidebar.width.desktopCollapse',
          ),
          '.sidebar': {
            transition:
              'width var(--tw-sidebar-transition-duration) var(--tw-sidebar-transition-timing)',
