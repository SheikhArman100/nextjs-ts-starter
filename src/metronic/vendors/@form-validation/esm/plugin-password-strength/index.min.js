...
var o = (function (t) {
  function o(e) {
    ...
    return (
      ...
      (o.validatePassword = o.checkPasswordStrength.bind(o)),
  ...
  return (
    ...
    (o.prototype.install = function () {
      ...
      this.core.registerValidator(
        ...
        this.core.addField(this.opts.field, {
          validators:
            ((t = {}),
            (t[o.PASSWORD_STRENGTH_VALIDATOR] = {
    ...
    (o.prototype.checkPasswordStrength = function () {
      ...
      return {
        validate: function (e) {
          ...
          var a = zxcvbn(o),
            i = a.score,
            r = a.feedback.warning || 'The password is weak';
          return i < t.opts.minimalScore
            ? { message: r, meta: { message: r, score: i }, valid: !1 }
            : { meta: { message: r, score: i }, valid: !0 };
        },
      };
    }),
    (o.prototype.onValidatorValidated = function (t) {
      if (
        ...
        t.validator === o.PASSWORD_STRENGTH_VALIDATOR &&
        t.result.meta
      ) {
        var e = t.result.meta.message,
          a = t.result.meta.score;
        this.opts.onValidated(t.result.valid, e, a);
      }
    }),
