 ...
 * (c) 2013 - 2023 Nguyen Huu Phuoc <me@phuoc.ng>
 */
var mod11And10$1 = algorithms.mod11And10;
/**
...
function frVat(value) {
  ...
  if (/^[0-9]{2}$/.test(v.substr(0, 2))) {
    ...
    if (/^[0-9]$/.test(v.charAt(0))) {
      check =
        alphabet.indexOf(v.charAt(0)) * 24 + alphabet.indexOf(v.charAt(1)) - 10;
    } else {
      check =
...
function luVat(value) {
  ...
  return {
    meta: {},
    valid:
      parseInt(v.substring(0, 6), 10) % 89 === parseInt(v.substring(6, 8), 10),
  };
}
 ...
 * (c) 2013 - 2023 Nguyen Huu Phuoc <me@phuoc.ng>
 */
var mod97And10 = algorithms.mod97And10;
/**
