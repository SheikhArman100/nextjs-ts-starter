...
var i = (function (t) {
  function i(e) {
    ...
    return (
      (i.fieldValidHandler = i.onFieldValid.bind(i)),
      (i.fieldInvalidHandler = i.onFieldInvalid.bind(i)),
      i
    );
  }
  return (
            ...
            date: {
              ...
              max: function () {
                return i.querySelector(
                  '[name="'.concat(t.opts.endDate.field, '"]'),
                ).value;
              },
        ...
        .addField(this.opts.endDate.field, {
          validators: {
            date: {
              ...
              min: function () {
                return i.querySelector(
                  '[name="'.concat(t.opts.startDate.field, '"]'),
                ).value;
              },
            },
          },
    ...
    (i.prototype.onFieldInvalid = function (t) {
      switch (t) {
    ...
    (i.prototype.onFieldValid = function (t) {
      switch (t) {
        case this.opts.startDate.field:
