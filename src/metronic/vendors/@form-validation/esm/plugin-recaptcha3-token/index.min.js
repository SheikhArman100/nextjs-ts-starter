...
var o = (function (t) {
  function o(e) {
    ...
    return (
      ...
      (o.onValidHandler = o.onFormValid.bind(o)),
      o
    );
  }
  return (
    ...
    (o.prototype.install = function () {
      ...
      var t =
        void 0 === window[o.LOADED_CALLBACK]
          ? function () {}
      ...
      if (!document.body.querySelector('script[src="'.concat(e, '"]'))) {
