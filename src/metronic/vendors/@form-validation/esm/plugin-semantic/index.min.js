    ...
    return (
      ...
      (t.prototype.onIconPlaced = function (e) {
        ...
        if ('checkbox' === t || 'radio' === t) {
          ...
          r(e.iconElement, { 'fv-plugins-icon-check': !0 }),
      ...
      (t.prototype.onMessagePlaced = function (e) {
        ...
        if (('checkbox' === t || 'radio' === t) && n > 1) {
          var r = e.elements[n - 1].parentElement;
          o(r, t) &&
            o(r, 'ui') &&
            r.parentElement.insertBefore(e.messageElement, r.nextSibling);
        }
      }),
      t
    );
  })(t);
export { i as Semantic };
