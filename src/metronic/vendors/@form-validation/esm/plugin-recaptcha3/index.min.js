...
var n = t.fetch,
  ...
  r = (function (t) {
    function e(e) {
      ...
      return (
        (o.opts = Object.assign({}, { minimumScore: 0 }, c(e))),
    ...
    return (
      ...
      (e.prototype.install = function () {
        ...
        window[e.LOADED_CALLBACK] = function () {
          ...
          c.setAttribute('type', 'hidden'),
            c.setAttribute('name', e.CAPTCHA_FIELD),
            document.getElementById(t.opts.element).appendChild(c),
                  ...
                  promise: function (o) {
                    return new Promise(function (o, c) {
                      window.grecaptcha
                        ...
                        .then(function (r) {
                          var i;
                          n(t.opts.backendVerificationUrl, {
                            method: 'POST',
                            params: ((i = {}), (i[e.CAPTCHA_FIELD] = r), i),
                          })
                            .then(function (e) {
                              var n =
                                'true' === ''.concat(e.success) &&
                                e.score >= t.opts.minimumScore;
                              o({
                                message: e.message || t.opts.message,
                                meta: e,
                                valid: n,
                              });
                            })
      ...
      (e.prototype.onIconPlaced = function (t) {
        t.field === e.CAPTCHA_FIELD && (t.iconElement.style.display = 'none');
      }),
      (e.CAPTCHA_FIELD = '___g-recaptcha-token___'),
      (e.LOADED_CALLBACK = '___reCaptcha3Loaded___'),
      e
    );
  })(e);
export { r as Recaptcha3 };
