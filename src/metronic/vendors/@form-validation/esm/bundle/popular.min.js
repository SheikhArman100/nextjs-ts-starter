  ...
  var e = function (t, n) {
    ...
    t = (function (t) {
      function n(e) {
        ...
        return (
          (n.statuses = new Map()),
          (n.opts = Object.assign({}, { onStatusChanged: function () {} }, e)),
          ...
          if (this.messages.has(o)) {
            ...
            if (s || e.result.valid)
              ...
              (l.innerHTML = this.getMessage(e.result)),
                ...
                this.opts.clazz && n(l, (((t = {})[this.opts.clazz] = !0), t)),
                a.appendChild(l),
                this.core.emit('plugins.message.displayed', {
                  element: e.element,
                  field: e.field,
  ...
  var e = r,
    ...
    a = (function (e) {
      ...
      return (
        ...
        (r.prototype.prepareElementContainer = function (e, t) {
          var n,
            r =
        ...
        (r.prototype.removeClasses = function (e, t) {
          var n,
            r = this,
      ...
      return {
        validate: function (i) {
          ...
          return o.inclusive
            ...
            : {
                message: t(
                  i.l10n ? o.message || i.l10n.between.notInclusive : o.message,
                  [''.concat(a), ''.concat(s)],
                ),
                valid: parseFloat(r) > a && parseFloat(r) < s,
              };
...
Ae.exports = (function () {
  ...
  return (
    (we.CREDIT_CARD_TYPES = t),
    (we.creditCard = function () {
      return {
        validate: function (n) {
    ...
    (Ie.date = function () {
      return {
        validate: function (e) {
          ...
          var H = 'function' == typeof r.min ? r.min() : r.min,
            S = H instanceof Date ? H : H ? o(H, y, v) : O,
            k = 'function' == typeof r.max ? r.max() : r.max,
            P = k instanceof Date ? k : k ? o(k, y, v) : O,
            j = H instanceof Date ? a(S, r.format) : H,
            N = k instanceof Date ? a(P, r.format) : k;
          switch (!0) {
            case !!j && !N:
              return {
            ...
            case !!N && !!j:
              return {
                ...
                meta: { date: O },
                valid: O.getTime() <= P.getTime() && O.getTime() >= S.getTime(),
              };
            default:
      ...
      return {
        validate: function (e) {
          ...
          return i.inclusive
            ? {
                message: t(
                  e.l10n ? i.message || e.l10n.greaterThan.default : i.message,
                  ''.concat(r),
                ),
      ...
      return {
        validate: function (t) {
          ...
          var n = Object.assign(
            ...
            o = new RegExp(
              '^-?[0-9]{1,3}('.concat(r, '[0-9]{3})*(').concat(i, '[0-9]+)?$'),
            ),
            a = new RegExp(r, 'g'),
            s = ''.concat(t.value);
      ...
      return {
        validate: function (t) {
          ...
          var r = '.' === n.decimalSeparator ? '\\.' : n.decimalSeparator,
            ...
            a = new RegExp(
              '^-?[0-9]{1,3}('.concat(o, '[0-9]{3})*(').concat(r, '[0-9]+)?$'),
            ),
            s = new RegExp(o, 'g');
...
var Bt = zt.exports,
  ...
  qt = {
    ...
    date: He.date,
    different: je.different,
    digits: Me.digits,
    emailAddress: Ue.emailAddress,
    file: Ge.file,
    greaterThan: Je.greaterThan,
    identical: et.identical,
    integer: rt.integer,
    ip: lt.ip,
    lessThan: ft.lessThan,
    notEmpty: vt.notEmpty,
    numeric: Et.numeric,
    promise: wt.promise,
    regexp: It.regexp,
    remote: kt.remote,
    stringCase: Lt.stringCase,
    stringLength: Rt.stringLength,
    uri: Bt.uri,
  },
  Gt = function (e, t) {
    var n = r.formValidation(e, t);
    return (
      Object.keys(qt).forEach(function (e) {
        return n.registerValidator(e, qt[e]);
      }),
      n
    );
  },
