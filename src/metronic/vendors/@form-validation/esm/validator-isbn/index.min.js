...
function e() {
  return {
    validate: function (e) {
      ...
      var a,
        l,
        s = e.value.replace(/[^0-9X]/gi, '').split(''),
        d = s.length,
        u = 0;
      switch (t) {
        case 'ISBN10':
          for (u = 0, a = 0; a < d - 1; a++) u += parseInt(s[a], 10) * (10 - a);
          return (
            11 === (l = 11 - (u % 11)) ? (l = 0) : 10 === l && (l = 'X'),
            { meta: { type: t }, valid: ''.concat(l) === s[d - 1] }
          );
        case 'ISBN13':
          for (u = 0, a = 0; a < d - 1; a++)
            u += a % 2 == 0 ? parseInt(s[a], 10) : 3 * parseInt(s[a], 10);
          return (
            10 === (l = 10 - (u % 10)) && (l = '0'),
            { meta: { type: t }, valid: ''.concat(l) === s[d - 1] }
          );
