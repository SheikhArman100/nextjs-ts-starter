...
import { Framework as t } from '../plugin-framework/index.min.js';
var n = function (e, t) {
  return (
    (n =
    ...
    return (
      ...
      (t.prototype.handleElementValidated = function (e) {
        ...
        if (
          ('checkbox' === t || 'radio' === t) &&
          e.elements.length > 1 &&
          i(e.element, 'form-check-input')
        ) {
          var n = e.element.parentElement;
          i(n, 'form-check') &&
            i(n, 'form-check-inline') &&
            l(n, { 'is-invalid': !e.valid, 'is-valid': e.valid });
        }
      }),
      (t.prototype.onIconPlaced = function (e) {
        l(e.element, { 'fv-plugins-icon-input': !0 });
        var t = e.element.parentElement;
        i(t, 'input-group') &&
          (t.parentElement.insertBefore(e.iconElement, t.nextSibling),
          e.element.nextElementSibling &&
            i(e.element.nextElementSibling, 'input-group-text') &&
            l(e.iconElement, { 'fv-plugins-icon-input-group': !0 }));
      ...
      (t.prototype.onMessagePlaced = function (e) {
        ...
        if (i(t, 'input-group'))
          return (
            t.appendChild(e.messageElement), void l(t, { 'has-validation': !0 })
          );
        var n = e.element.getAttribute('type');
        ('checkbox' !== n && 'radio' !== n) ||
          !i(e.element, 'form-check-input') ||
          i(t, 'form-check') ||
          i(t, 'form-check-inline') ||
