...
import { Alias as i } from '../plugin-alias/index.min.js';
var s = function (e, t) {
  return (
    (s =
...
var n = e.removeUndefined,
  o = (function (e) {
    function t(t) {
      var i = e.call(this, t) || this;
      return (
        (i.opts = Object.assign({}, { suggestion: !1 }, n(t))),
        (i.messageDisplayedHandler = i.onMessageDisplayed.bind(i)),
        i
      );
    }
    return (
      ...
      (t.prototype.install = function () {
        ...
        this.core
          .registerPlugin(t.ALIAS_PLUGIN, new i({ mailgun: 'remote' }))
      ...
      (t.ALIAS_PLUGIN = '___mailgunAlias'),
      t
    );
  })(t);
export { o as Mailgun };
