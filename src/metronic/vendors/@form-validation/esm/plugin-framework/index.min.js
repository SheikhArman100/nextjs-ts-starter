...
import { utils as e, Plugin as t } from '../core/index.min.js';
import { Message as o } from '../plugin-message/index.min.js';
var n = function (e, t) {
  return (
    (n =
    ...
    return (
                ...
                container: function (e, t) {
                  var s =
                      'string' == typeof n.opts.rowSelector
                        ? n.opts.rowSelector
                        : n.opts.rowSelector(e, t),
                    a = i(t, s);
                  return o.getClosestContainer(t, a, n.opts.rowPattern);
                },
              }),
            ),
      ...
      (t.prototype.onElementValidated = function (e) {
        ...
        i.forEach(function (t) {
          ...
          s(
            t,
            (((o = {})[n.opts.eleValidClass] = e.valid),
            (o[n.opts.eleInvalidClass] = !e.valid),
            o),
          );
        });
