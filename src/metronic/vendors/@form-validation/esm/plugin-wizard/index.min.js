...
import { Excluded as n } from '../plugin-excluded/index.min.js';
var i = function (t, e) {
  return (
    (i =
    ...
    return (
      ...
      (e.prototype.install = function () {
        ...
        this.core.registerPlugin(
          ...
          this.opts.isFieldExcluded
            ? new n({ excluded: this.opts.isFieldExcluded })
            : new n(),
        );
        ...
        (this.steps = [].slice.call(
          ...
          this.steps.forEach(function (t) {
            var e;
            s(t, (((e = {})[i.opts.stepClass] = !0), e));
          }),
          s(this.steps[0], (((t = {})[this.opts.activeStepClass] = !0), t)),
      ...
      (e.prototype.goToStep = function (t) {
        ...
        this.isEnabled &&
          ...
          s(this.steps[t], (((n = {})[this.opts.activeStepClass] = !0), n)),
          (this.currentStep = t));
      }),
