var e = {
  base64: { default: 'Будь ласка, введіть коректний рядок base64' },
  between: {
    default: 'Будь ласка, введіть значення від %s до %s',
    notInclusive: 'Будь ласка, введіть значення між %s і %s',
  },
  bic: { default: 'Будь ласка, введіть правильний номер BIC' },
  callback: { default: 'Будь ласка, введіть коректне значення' },
  choice: {
  ...
  color: { default: 'Будь ласка, введіть правильний номер кольору' },
  creditCard: {
    default: 'Будь ласка, введіть правильний номер кредитної картки',
  },
  cusip: { default: 'Будь ласка, введіть правильний номер CUSIP' },
  date: {
  ...
  different: { default: 'Будь ласка, введіть інше значення' },
  digits: { default: 'Будь ласка, введіть тільки цифри' },
  ean: { default: 'Будь ласка, введіть правильний номер EAN' },
  ein: { default: 'Будь ласка, введіть правильний номер EIN' },
  emailAddress: { default: 'Будь ласка, введіть правильну адресу e-mail' },
  file: { default: 'Будь ласка, виберіть файл' },
  greaterThan: {
    default: 'Будь ласка, введіть значення більше або рівне %s',
    notInclusive: 'Будь ласка, введіть значення більше %s',
  },
  grid: { default: 'Будь ласка, введіть правильний номер GRId' },
  hex: { default: 'Будь ласка, введіть правильний шістнадцятковий(16) номер' },
  iban: {
    countries: {
      AD: 'Андоррі',
  ...
  identical: { default: 'Будь ласка, введіть таке ж значення' },
  imei: { default: 'Будь ласка, введіть правильний номер IMEI' },
  imo: { default: 'Будь ласка, введіть правильний номер IMO' },
  integer: { default: 'Будь ласка, введіть правильне ціле значення' },
  ip: {
  ...
  isbn: { default: 'Будь ласка, введіть правильний номер ISBN' },
  isin: { default: 'Будь ласка, введіть правильний номер ISIN' },
  ismn: { default: 'Будь ласка, введіть правильний номер ISMN' },
  issn: { default: 'Будь ласка, введіть правильний номер ISSN' },
  lessThan: {
    default: 'Будь ласка, введіть значення менше або рівне %s',
    notInclusive: 'Будь ласка, введіть значення менше ніж %s',
  },
  mac: { default: 'Будь ласка, введіть правильну MAC-адресу' },
  meid: { default: 'Будь ласка, введіть правильний номер MEID' },
  notEmpty: { default: 'Будь ласка, введіть значення' },
  numeric: { default: 'Будь ласка, введіть коректне дійсне число' },
  phone: {
    countries: {
      AE: "Об'єднаних Арабських Еміратах",
      BG: 'Болгарії',
  ...
  promise: { default: 'Будь ласка, введіть коректне значення' },
  regexp: { default: 'Будь ласка, введіть значення відповідне до шаблону' },
  remote: { default: 'Будь ласка, введіть правильне значення' },
  rtn: { default: 'Будь ласка, введіть правильний номер RTN' },
  sedol: { default: 'Будь ласка, введіть правильний номер SEDOL' },
  siren: { default: 'Будь ласка, введіть правильний номер SIREN' },
  siret: { default: 'Будь ласка, введіть правильний номер SIRET' },
  step: { default: 'Будь ласка, введіть правильний крок %s' },
  stringCase: {
  ...
  uri: { default: 'Будь ласка, введіть правильний URI' },
  uuid: {
  ...
  vin: { default: 'Будь ласка, введіть правильний номер VIN' },
  zipCode: {
    countries: {
      AT: 'Австрії',
      BG: 'Болгарії',
