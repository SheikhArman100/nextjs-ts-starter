var e = {
  base64: { default: 'Пожалуйста, введите корректную строку base64' },
  between: {
    default: 'Пожалуйста, введите значение от %s до %s',
    notInclusive: 'Пожалуйста, введите значение между %s и %s',
  },
  bic: { default: 'Пожалуйста, введите правильный номер BIC' },
  callback: { default: 'Пожалуйста, введите корректное значение' },
  choice: {
  ...
  color: { default: 'Пожалуйста, введите правильный номер цвета' },
  creditCard: {
    default: 'Пожалуйста, введите правильный номер кредитной карты',
  },
  cusip: { default: 'Пожалуйста, введите правильный номер CUSIP' },
  date: {
  ...
  different: { default: 'Пожалуйста, введите другое значение' },
  digits: { default: 'Пожалуйста, введите только цифры' },
  ean: { default: 'Пожалуйста, введите правильный номер EAN' },
  ein: { default: 'Пожалуйста, введите правильный номер EIN' },
  emailAddress: { default: 'Пожалуйста, введите правильный адрес эл. почты' },
  file: { default: 'Пожалуйста, выберите файл' },
  greaterThan: {
    default: 'Пожалуйста, введите значение большее или равное %s',
    notInclusive: 'Пожалуйста, введите значение больше %s',
  },
  grid: { default: 'Пожалуйста, введите правильный номер GRId' },
  hex: { default: 'Пожалуйста, введите правильное шестнадцатиричное число' },
  iban: {
    countries: {
      AD: 'Андорре',
  ...
  identical: { default: 'Пожалуйста, введите такое же значение' },
  imei: { default: 'Пожалуйста, введите правильный номер IMEI' },
  imo: { default: 'Пожалуйста, введите правильный номер IMO' },
  integer: { default: 'Пожалуйста, введите правильное целое число' },
  ip: {
  ...
  isbn: { default: 'Пожалуйста, введите правильный номер ISBN' },
  isin: { default: 'Пожалуйста, введите правильный номер ISIN' },
  ismn: { default: 'Пожалуйста, введите правильный номер ISMN' },
  issn: { default: 'Пожалуйста, введите правильный номер ISSN' },
  lessThan: {
    default: 'Пожалуйста, введите значение меньшее или равное %s',
    notInclusive: 'Пожалуйста, введите значение меньше %s',
  },
  mac: { default: 'Пожалуйста, введите правильный MAC-адрес' },
  meid: { default: 'Пожалуйста, введите правильный номер MEID' },
  notEmpty: { default: 'Пожалуйста, введите значение' },
  numeric: { default: 'Пожалуйста, введите корректное действительное число' },
  phone: {
    countries: {
      AE: 'Объединённых Арабских Эмиратах',
      BG: 'Болгарии',
  ...
  promise: { default: 'Пожалуйста, введите корректное значение' },
  regexp: { default: 'Пожалуйста, введите значение соответствующее шаблону' },
  remote: { default: 'Пожалуйста, введите правильное значение' },
  rtn: { default: 'Пожалуйста, введите правильный номер RTN' },
  sedol: { default: 'Пожалуйста, введите правильный номер SEDOL' },
  siren: { default: 'Пожалуйста, введите правильный номер SIREN' },
  siret: { default: 'Пожалуйста, введите правильный номер SIRET' },
  step: { default: 'Пожалуйста, введите правильный шаг %s' },
  stringCase: {
  ...
  uri: { default: 'Пожалуйста, введите правильный URI' },
  uuid: {
  ...
  vin: { default: 'Пожалуйста, введите правильный номер VIN' },
  zipCode: {
    countries: {
      AT: 'Австрии',
      BG: 'Болгарии',
