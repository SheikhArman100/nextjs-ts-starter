var i = {
  base64: { default: 'Si prega di inserire un valore codificato in Base 64' },
  between: {
    default: 'Si prega di inserire un valore tra %s e %s',
    notInclusive: 'Si prega di scegliere rigorosamente un valore tra %s e %s',
  },
  bic: { default: 'Si prega di inserire un numero BIC valido' },
  callback: { default: 'Si prega di inserire un valore valido' },
  choice: {
  ...
  color: { default: 'Si prega di inserire un colore valido' },
  creditCard: {
    default: 'Si prega di inserire un numero di carta di credito valido',
  },
  cusip: { default: 'Si prega di inserire un numero CUSIP valido' },
  date: {
  ...
  different: { default: 'Si prega di inserire un valore differente' },
  digits: { default: 'Si prega di inserire solo numeri' },
  ean: { default: 'Si prega di inserire un numero EAN valido' },
  ein: { default: 'Si prega di inserire un numero EIN valido' },
  emailAddress: { default: 'Si prega di inserire un indirizzo email valido' },
  file: { default: 'Si prega di scegliere un file valido' },
  greaterThan: {
    default: 'Si prega di inserire un numero maggiore o uguale a %s',
    notInclusive: 'Si prega di inserire un numero maggiore di %s',
  },
  grid: { default: 'Si prega di inserire un numero GRId valido' },
  hex: { default: 'Si prega di inserire un numero esadecimale valido' },
  iban: {
    countries: {
      AD: 'Andorra',
  ...
  identical: { default: 'Si prega di inserire un valore identico' },
  imei: { default: 'Si prega di inserire un numero IMEI valido' },
  imo: { default: 'Si prega di inserire un numero IMO valido' },
  integer: { default: 'Si prega di inserire un numero valido' },
  ip: {
    default: 'Please enter a valid IP address',
    ipv4: 'Si prega di inserire un indirizzo IPv4 valido',
    ipv6: 'Si prega di inserire un indirizzo IPv6 valido',
  },
  isbn: { default: 'Si prega di inserire un numero ISBN valido' },
  isin: { default: 'Si prega di inserire un numero ISIN valido' },
  ismn: { default: 'Si prega di inserire un numero ISMN valido' },
  issn: { default: 'Si prega di inserire un numero ISSN valido' },
  lessThan: {
    default: 'Si prega di inserire un valore minore o uguale a %s',
    notInclusive: 'Si prega di inserire un valore minore di %s',
  },
  mac: { default: 'Si prega di inserire un valido MAC address' },
  meid: { default: 'Si prega di inserire un numero MEID valido' },
  notEmpty: { default: 'Si prega di non lasciare il campo vuoto' },
  numeric: { default: 'Si prega di inserire un numero con decimali valido' },
  phone: {
    countries: {
      AE: 'Emirati Arabi Uniti',
      BG: 'Bulgaria',
  ...
  promise: { default: 'Si prega di inserire un valore valido' },
  regexp: { default: 'Inserisci un valore che corrisponde al modello' },
  remote: { default: 'Si prega di inserire un valore valido' },
  rtn: { default: 'Si prega di inserire un numero RTN valido' },
  sedol: { default: 'Si prega di inserire un numero SEDOL valido' },
  siren: { default: 'Si prega di inserire un numero SIREN valido' },
  siret: { default: 'Si prega di inserire un numero SIRET valido' },
  step: { default: 'Si prega di inserire uno step valido di %s' },
  stringCase: {
  ...
  uri: { default: 'Si prega di inserire un URI valido' },
  uuid: {
  ...
  vin: { default: 'Si prega di inserire un numero VIN valido' },
  zipCode: {
    countries: {
      AT: 'Austria',
      BG: 'Bulgaria',
