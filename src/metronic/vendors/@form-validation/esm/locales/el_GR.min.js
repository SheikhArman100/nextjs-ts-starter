var e = {
  base64: { default: 'Παρακαλώ εισάγετε μια έγκυρη κωδικοποίηση base 64' },
  between: {
    default: 'Παρακαλώ εισάγετε μια τιμή μεταξύ %s και %s',
    notInclusive: 'Παρακαλώ εισάγετε μια τιμή μεταξύ %s και %s αυστηρά',
  },
  bic: { default: 'Παρακαλώ εισάγετε έναν έγκυρο αριθμό BIC' },
  callback: { default: 'Παρακαλώ εισάγετε μια έγκυρη τιμή' },
  choice: {
  ...
  color: { default: 'Παρακαλώ εισάγετε ένα έγκυρο χρώμα' },
  creditCard: {
    default: 'Παρακαλώ εισάγετε έναν έγκυρο αριθμό πιστωτικής κάρτας',
  },
  cusip: { default: 'Παρακαλώ εισάγετε έναν έγκυρο αριθμό CUSIP' },
  date: {
  ...
  different: { default: 'Παρακαλώ εισάγετε μια διαφορετική τιμή' },
  digits: { default: 'Παρακαλώ εισάγετε μόνο ψηφία' },
  ean: { default: 'Παρακαλώ εισάγετε έναν έγκυρο αριθμό EAN' },
  ein: { default: 'Παρακαλώ εισάγετε έναν έγκυρο αριθμό EIN' },
  emailAddress: { default: 'Παρακαλώ εισάγετε ένα έγκυρο email' },
  file: { default: 'Παρακαλώ επιλέξτε ένα έγκυρο αρχείο' },
  greaterThan: {
    default: 'Παρακαλώ εισάγετε μια τιμή μεγαλύτερη ή ίση με %s',
    notInclusive: 'Παρακαλώ εισάγετε μια τιμή μεγαλύτερη από %s',
  },
  grid: { default: 'Παρακαλώ εισάγετε έναν έγκυρο αριθμό GRId' },
  hex: { default: 'Παρακαλώ εισάγετε έναν έγκυρο δεκαεξαδικό αριθμό' },
  iban: {
    countries: {
      AD: 'Ανδόρα',
  ...
  identical: { default: 'Παρακαλώ εισάγετε την ίδια τιμή' },
  imei: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό IMEI' },
  imo: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό IMO' },
  integer: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό' },
  ip: {
  ...
  isbn: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό ISBN' },
  isin: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό ISIN' },
  ismn: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό ISMN' },
  issn: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό ISSN' },
  lessThan: {
    default: 'Παρακαλώ εισάγετε μια τιμή μικρότερη ή ίση με %s',
    notInclusive: 'Παρακαλώ εισάγετε μια τιμή μικρότερη από %s',
  },
  mac: { default: 'Παρακαλώ εισάγετε μία έγκυρη MAC διεύθυνση' },
  meid: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό MEID' },
  notEmpty: { default: 'Παρακαλώ εισάγετε μια τιμή' },
  numeric: { default: 'Παρακαλώ εισάγετε ένα έγκυρο δεκαδικό αριθμό' },
  phone: {
    countries: {
      AE: 'Ηνωμένα Αραβικά Εμιράτα',
      BG: 'Βουλγαρία',
  ...
  promise: { default: 'Παρακαλώ εισάγετε μια έγκυρη τιμή' },
  regexp: {
    default: 'Παρακαλώ εισάγετε μια τιμή όπου ταιριάζει στο υπόδειγμα',
  },
  remote: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό' },
  rtn: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό RTN' },
  sedol: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό SEDOL' },
  siren: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό SIREN' },
  siret: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό SIRET' },
  step: { default: 'Παρακαλώ εισάγετε ένα έγκυρο βήμα από %s' },
  stringCase: {
  ...
  uri: { default: 'Παρακαλώ εισάγετε ένα έγκυρο URI' },
  uuid: {
  ...
  vin: { default: 'Παρακαλώ εισάγετε ένα έγκυρο αριθμό VIN' },
  zipCode: {
    countries: {
      AT: 'Αυστρία',
      BG: 'Βουλγαρία',
