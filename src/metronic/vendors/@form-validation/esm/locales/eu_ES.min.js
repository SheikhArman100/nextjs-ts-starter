var a = {
  base64: { default: 'Mesedez sartu base 64an balore egoki bat' },
  between: {
    default: 'Mesedez sartu %s eta %s artean balore bat',
    notInclusive: 'Mesedez sartu %s eta %s arteko balore bat soilik',
  },
  bic: { default: 'Mesedez sartu BIC zenbaki egoki bat' },
  callback: { default: 'Mesedez sartu balore egoki bat' },
  choice: {
  ...
  color: { default: 'Mesedezn sartu kolore egoki bat' },
  creditCard: {
    default: 'Mesedez sartu kerditu-txartelaren zenbaki egoki bat',
  },
  cusip: { default: 'Mesedez sartu CUSIP zenbaki egoki bat' },
  date: {
  ...
  different: { default: 'Mesedez sartu balore ezberdin bat' },
  digits: { default: 'Mesedez sigituak soilik sartu' },
  ean: { default: 'Mesedez EAN zenbaki egoki bat sartu' },
  ein: { default: 'Mesedez EIN zenbaki egoki bat sartu' },
  emailAddress: { default: 'Mesedez e-posta egoki bat sartu' },
  file: { default: 'Mesedez artxibo egoki bat aukeratu' },
  greaterThan: {
  ...
  grid: { default: 'Mesedez GRID zenbaki egoki bat sartu' },
  hex: { default: 'Mesedez sartu balore hamaseitar egoki bat' },
  iban: {
    countries: {
      AD: 'Andorra',
  ...
  identical: { default: 'Mesedez, balio bera sartu' },
  imei: { default: 'Mesedez, IMEI baliozko zenbaki bat sartu' },
  imo: { default: 'Mesedez, IMO baliozko zenbaki bat sartu' },
  integer: { default: 'Mesedez, baliozko zenbaki bat sartu' },
  ip: {
  ...
  isbn: { default: 'Mesedez, ISBN baliozko zenbaki bat sartu' },
  isin: { default: 'Mesedez, ISIN baliozko zenbaki bat sartu' },
  ismn: { default: 'Mesedez, ISMM baliozko zenbaki bat sartu' },
  issn: { default: 'Mesedez, ISSN baliozko zenbaki bat sartu' },
  lessThan: {
    default: 'Mesedez, %s en balio txikiagoa edo berdina sartu',
    notInclusive: 'Mesedez, %s baino balio txikiago sartu',
  },
  mac: { default: 'Mesedez, baliozko MAC helbide bat sartu' },
  meid: { default: 'Mesedez, MEID baliozko zenbaki bat sartu' },
  notEmpty: { default: 'Mesedez balore bat sartu' },
  numeric: { default: 'Mesedez, baliozko zenbaki hamartar bat sartu' },
  phone: {
    countries: {
  ...
  promise: { default: 'Mesedez sartu balore egoki bat' },
  regexp: { default: 'Mesedez, patroiarekin bat datorren balio bat sartu' },
  remote: { default: 'Mesedez balore egoki bat sartu' },
  rtn: { default: 'Mesedez, RTN baliozko zenbaki bat sartu' },
  sedol: { default: 'Mesedez, SEDOL baliozko zenbaki bat sartu' },
  siren: { default: 'Mesedez, SIREN baliozko zenbaki bat sartu' },
  siret: { default: 'Mesedez, SIRET baliozko zenbaki bat sartu' },
  step: { default: 'Mesedez %s -ko pausu egoki bat sartu' },
  stringCase: {
  ...
  uri: { default: 'Mesedez, URI egoki bat sartu.' },
  uuid: {
  ...
  vin: { default: 'Mesedez, baliozko VIN zenbaki bat sartu' },
  zipCode: {
    countries: {
      AT: 'Austria',
      BG: 'Bulgaria',
