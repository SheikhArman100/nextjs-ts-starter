var i = {
  base64: { default: 'Si us plau introdueix un valor vàlid en base 64' },
  between: {
    default: 'Si us plau introdueix un valor entre %s i %s',
    notInclusive: 'Si us plau introdueix un valor comprès entre %s i %s',
  },
  bic: { default: 'Si us plau introdueix un nombre BIC vàlid' },
  callback: { default: 'Si us plau introdueix un valor vàlid' },
  choice: {
  ...
  color: { default: 'Si us plau introdueix un color vàlid' },
  creditCard: {
    default: 'Si us plau introdueix un nombre vàlid de targeta de crèdit',
  },
  cusip: { default: 'Si us plau introdueix un nombre CUSIP vàlid' },
  date: {
  ...
  different: { default: 'Si us plau introdueix un valor diferent' },
  digits: { default: 'Si us plau introdueix només dígits' },
  ean: { default: 'Si us plau introdueix un nombre EAN vàlid' },
  ein: { default: 'Si us plau introdueix un nombre EIN vàlid' },
  emailAddress: {
    default: 'Si us plau introdueix una adreça electrònica vàlida',
  },
  file: { default: 'Si us plau selecciona un arxiu vàlid' },
  greaterThan: {
    default: 'Si us plau introdueix un valor més gran o igual a %s',
    notInclusive: 'Si us plau introdueix un valor més gran que %s',
  },
  grid: { default: 'Si us plau introdueix un nombre GRId vàlid' },
  hex: { default: 'Si us plau introdueix un valor hexadecimal vàlid' },
  iban: {
    countries: {
      AD: 'Andorra',
  ...
  identical: { default: 'Si us plau introdueix exactament el mateix valor' },
  imei: { default: 'Si us plau introdueix un nombre IMEI vàlid' },
  imo: { default: 'Si us plau introdueix un nombre IMO vàlid' },
  integer: { default: 'Si us plau introdueix un nombre vàlid' },
  ip: {
  ...
  isbn: { default: 'Si us plau introdueix un nombre ISBN vàlid' },
  isin: { default: 'Si us plau introdueix un nombre ISIN vàlid' },
  ismn: { default: 'Si us plau introdueix un nombre ISMN vàlid' },
  issn: { default: 'Si us plau introdueix un nombre ISSN vàlid' },
  lessThan: {
    default: 'Si us plau introdueix un valor menor o igual a %s',
    notInclusive: 'Si us plau introdueix un valor menor que %s',
  },
  mac: { default: 'Si us plau introdueix una adreça MAC vàlida' },
  meid: { default: 'Si us plau introdueix nombre MEID vàlid' },
  notEmpty: { default: 'Si us plau introdueix un valor' },
  numeric: { default: 'Si us plau introdueix un nombre decimal vàlid' },
  phone: {
    countries: {
      AE: 'Emirats Àrabs Units',
      BG: 'Bulgària',
  ...
  promise: { default: 'Si us plau introdueix un valor vàlid' },
  regexp: {
    default: 'Si us plau introdueix un valor que coincideixi amb el patró',
  },
  remote: { default: 'Si us plau introdueix un valor vàlid' },
  rtn: { default: 'Si us plau introdueix un nombre RTN vàlid' },
  sedol: { default: 'Si us plau introdueix un nombre SEDOL vàlid' },
  siren: { default: 'Si us plau introdueix un nombre SIREN vàlid' },
  siret: { default: 'Si us plau introdueix un nombre SIRET vàlid' },
  step: { default: 'Si us plau introdueix un pas vàlid de %s' },
  stringCase: {
  ...
  uri: { default: 'Si us plau introdueix una URI vàlida' },
  uuid: {
  ...
  vin: { default: 'Si us plau introdueix un nombre VIN vàlid' },
  zipCode: {
    countries: {
      AT: 'Àustria',
      BG: 'Bulgària',
