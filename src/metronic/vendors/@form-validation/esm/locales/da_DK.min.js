var e = {
  ...
  bic: { default: 'Udfyld venligst dette felt med et gyldigt BIC-nummer' },
  callback: { default: 'Udfyld venligst dette felt med en gyldig værdi' },
  choice: {
  ...
  color: { default: 'Udfyld venligst dette felt med en gyldig farve' },
  creditCard: {
    default: 'Udfyld venligst dette felt med et gyldigt kreditkort-nummer',
  },
  cusip: { default: 'Udfyld venligst dette felt med et gyldigt CUSIP-nummer' },
  date: {
  ...
  different: { default: 'Udfyld venligst dette felt med en anden værdi' },
  digits: { default: 'Indtast venligst kun cifre' },
  ean: { default: 'Udfyld venligst dette felt med et gyldigt EAN-nummer' },
  ein: { default: 'Udfyld venligst dette felt med et gyldigt EIN-nummer' },
  emailAddress: {
    default: 'Udfyld venligst dette felt med en gyldig e-mail-adresse',
  },
  file: { default: 'Vælg venligst en gyldig fil' },
  greaterThan: {
  ...
  grid: { default: 'Udfyld venligst dette felt med et gyldigt GRId-nummer' },
  hex: {
  ...
  identical: { default: 'Udfyld venligst dette felt med den samme værdi' },
  imei: { default: 'Udfyld venligst dette felt med et gyldigt IMEI-nummer' },
  imo: { default: 'Udfyld venligst dette felt med et gyldigt IMO-nummer' },
  integer: { default: 'Udfyld venligst dette felt med et gyldigt tal' },
  ip: {
  ...
  isbn: { default: 'Udfyld venligst dette felt med et gyldigt ISBN-nummer' },
  isin: { default: 'Udfyld venligst dette felt med et gyldigt ISIN-nummer' },
  ismn: { default: 'Udfyld venligst dette felt med et gyldigt ISMN-nummer' },
  issn: { default: 'Udfyld venligst dette felt med et gyldigt ISSN-nummer' },
  lessThan: {
  ...
  mac: { default: 'Udfyld venligst dette felt med en gyldig MAC adresse' },
  meid: { default: 'Udfyld venligst dette felt med et gyldigt MEID-nummer' },
  notEmpty: { default: 'Udfyld venligst dette felt' },
  numeric: {
  ...
  promise: { default: 'Udfyld venligst dette felt med en gyldig værdi' },
  regexp: {
    default: 'Udfyld venligst dette felt med en værdi der matcher mønsteret',
  },
  remote: { default: 'Udfyld venligst dette felt med en gyldig værdi' },
  rtn: { default: 'Udfyld venligst dette felt med et gyldigt RTN-nummer' },
  sedol: { default: 'Udfyld venligst dette felt med et gyldigt SEDOL-nummer' },
  siren: { default: 'Udfyld venligst dette felt med et gyldigt SIREN-nummer' },
  siret: { default: 'Udfyld venligst dette felt med et gyldigt SIRET-nummer' },
  step: { default: 'Udfyld venligst dette felt med et gyldigt trin af %s' },
  stringCase: {
  ...
  uri: { default: 'Udfyld venligst dette felt med en gyldig URI' },
  uuid: {
  ...
  vin: { default: 'Udfyld venligst dette felt med et gyldigt VIN-nummer' },
  zipCode: {
    countries: {
      AT: 'Østrig',
      BG: 'Bulgarien',
