var e = {
  base64: { default: 'Ju lutem përdorni sistemin e kodimit Base64' },
  between: {
    default: 'Ju lutem vendosni një vlerë midis %s dhe %s',
    notInclusive: 'Ju lutem vendosni një vlerë rreptësisht midis %s dhe %s',
  },
  bic: { default: 'Ju lutem vendosni një numër BIC të vlefshëm' },
  callback: { default: 'Ju lutem vendosni një vlerë të vlefshme' },
  choice: {
  ...
  color: { default: 'Ju lutem vendosni një ngjyrë të vlefshme' },
  creditCard: {
    default: 'Ju lutem vendosni një numër karte krediti të vlefshëm',
  },
  cusip: { default: 'Ju lutem vendosni një numër CUSIP të vlefshëm' },
  date: {
  ...
  different: { default: 'Ju lutem vendosni një vlerë tjetër' },
  digits: { default: 'Ju lutem vendosni vetëm numra' },
  ean: { default: 'Ju lutem vendosni një numër EAN të vlefshëm' },
  ein: { default: 'Ju lutem vendosni një numër EIN të vlefshëm' },
  emailAddress: { default: 'Ju lutem vendosni një adresë email të vlefshme' },
  file: { default: 'Ju lutem përzgjidhni një skedar të vlefshëm' },
  greaterThan: {
  ...
  grid: { default: 'Ju lutem vendosni një numër GRId të vlefshëm' },
  hex: { default: 'Ju lutem vendosni një numër të saktë heksadecimal' },
  iban: {
    countries: {
      AD: 'Andora',
  ...
  identical: { default: 'Ju lutem vendosni të njëjtën vlerë' },
  imei: { default: 'Ju lutem vendosni numër IMEI të njëjtë' },
  imo: { default: 'Ju lutem vendosni numër IMO të vlefshëm' },
  integer: { default: 'Ju lutem vendosni një numër të vlefshëm' },
  ip: {
  ...
  isbn: { default: 'Ju lutem vendosni një numër ISBN të vlefshëm' },
  isin: { default: 'Ju lutem vendosni një numër ISIN të vlefshëm' },
  ismn: { default: 'Ju lutem vendosni një numër ISMN të vlefshëm' },
  issn: { default: 'Ju lutem vendosni një numër ISSN të vlefshëm' },
  lessThan: {
    default: 'Ju lutem vendosni një vlerë më të madhe ose të barabartë me %s',
    notInclusive: 'Ju lutem vendosni një vlerë më të vogël se %s',
  },
  mac: { default: 'Ju lutem vendosni një adresë MAC të vlefshme' },
  meid: { default: 'Ju lutem vendosni një numër MEID të vlefshëm' },
  notEmpty: { default: 'Ju lutem vendosni një vlerë' },
  numeric: {
  ...
  promise: { default: 'Ju lutem vendosni një vlerë të vlefshme' },
  regexp: { default: 'Ju lutem vendosni një vlerë që përputhet me modelin' },
  remote: { default: 'Ju lutem vendosni një vlerë të vlefshme' },
  rtn: { default: 'Ju lutem vendosni një numër RTN të vlefshëm' },
  sedol: { default: 'Ju lutem vendosni një numër SEDOL të vlefshëm' },
  siren: { default: 'Ju lutem vendosni një numër SIREN të vlefshëm' },
  siret: { default: 'Ju lutem vendosni një numër SIRET të vlefshëm' },
  step: { default: 'Ju lutem vendosni një hap të vlefshëm të %s' },
  stringCase: {
  ...
  uri: { default: 'Ju lutem vendosni një URI të vlefshme' },
  uuid: {
  ...
  vin: { default: 'Ju lutem vendosni një numër VIN të vlefshëm' },
  zipCode: {
    countries: {
      AT: 'Austri',
      BG: 'Bullgari',
