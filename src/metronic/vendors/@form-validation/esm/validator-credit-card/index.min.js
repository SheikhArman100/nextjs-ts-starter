...
import { algorithms as e } from '../core/index.min.js';
var t = e.luhn,
  r = {
...
function l() {
  return {
    validate: function (e) {
      ...
      var l = e.value.replace(/\D/g, '');
      if (!t(l)) return { meta: { type: null }, valid: !1 };
      for (var n = 0, i = Object.keys(r); n < i.length; n++) {
        var f = i[n];
        for (var p in r[f].prefix)
          if (
            e.value.substr(0, r[f].prefix[p].length) === r[f].prefix[p] &&
...
export { r as CREDIT_CARD_TYPES, l as creditCard };
