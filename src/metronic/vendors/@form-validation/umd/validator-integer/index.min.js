  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((a =
        ...
        (a.FormValidation.validators.integer = e(a.FormValidation)));
})(this, function (a) {
  'use strict';
    ...
    return {
      validate: function (a) {
        ...
        var o = Object.assign(
          ...
          t = '.' === o.decimalSeparator ? '\\.' : o.decimalSeparator,
          i = '.' === o.thousandsSeparator ? '\\.' : o.thousandsSeparator,
          r = new RegExp(
            '^-?[0-9]{1,3}('.concat(i, '[0-9]{3})*(').concat(t, '[0-9]+)?$'),
          ),
          n = new RegExp(i, 'g'),
          d = ''.concat(a.value);
        if (!r.test(d)) return { valid: !1 };
        i && (d = d.replace(n, '')), t && (d = d.replace(t, '.'));
        var l = parseFloat(d);
