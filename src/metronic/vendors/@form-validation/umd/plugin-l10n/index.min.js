...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.plugins.L10n = e(t.FormValidation)));
})(this, function (t) {
  'use strict';
  var e = function (t, o) {
    return (
  ...
  return (function (t) {
    function o(e) {
      ...
      return (o.messageFilter = o.getMessage.bind(o)), o;
    }
    return (
      (function (t, o) {
      ...
      (o.prototype.getMessage = function (t, e, o) {
        if (!this.isEnabled) return '';
        if (this.opts[e] && this.opts[e][o]) {
          var i = this.opts[e][o],
            n = typeof i;
          if ('object' === n && i[t]) return i[t];
          if ('function' === n) {
            var r = i.apply(this, [e, o]);
            return r && r[t] ? r[t] : '';
          }
        }
        return '';
