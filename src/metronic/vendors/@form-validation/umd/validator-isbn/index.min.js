  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((e =
        ...
        (e.FormValidation.validators.isbn = t()));
})(this, function () {
  'use strict';
  return function () {
    return {
      validate: function (e) {
        ...
        switch (t) {
          case 'ISBN10':
            for (s = 0, a = 0; a < n - 1; a++)
              s += parseInt(l[a], 10) * (10 - a);
            return (
              11 === (d = 11 - (s % 11)) ? (d = 0) : 10 === d && (d = 'X'),
              { meta: { type: t }, valid: ''.concat(d) === l[n - 1] }
            );
          case 'ISBN13':
            for (s = 0, a = 0; a < n - 1; a++)
              s += a % 2 == 0 ? parseInt(l[a], 10) : 3 * parseInt(l[a], 10);
            return (
              10 === (d = 10 - (s % 10)) && (d = '0'),
              { meta: { type: t }, valid: ''.concat(d) === l[n - 1] }
            );
