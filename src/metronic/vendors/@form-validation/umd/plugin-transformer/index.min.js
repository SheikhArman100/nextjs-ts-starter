...
!(function (t, o) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.plugins.Transformer = o(t.FormValidation)));
})(this, function (t) {
  'use strict';
  var o = function (t, e) {
    return (
  ...
  return (function (t) {
    function e(o) {
      ...
      return (e.valueFilter = e.getElementValue.bind(e)), e;
    }
    return (
      (function (t, e) {
      ...
      (e.prototype.getElementValue = function (t, o, e, i) {
        return this.isEnabled &&
          this.opts[o] &&
          this.opts[o][i] &&
          'function' == typeof this.opts[o][i]
          ? this.opts[o][i].apply(this, [o, e, i])
          : t;
      }),
      e
    );
