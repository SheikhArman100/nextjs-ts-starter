...
!(function (e, t) {
          ...
          (n.prototype.prepareHandler = function (e, t) {
            ...
            t.forEach(function (t) {
              ...
              i.forEach(function (i) {
                ...
                n.handlers.push({ element: t, event: i, field: e, handler: r }),
          ...
          validate: function (n) {
            ...
            for (var r = 0, o = Object.keys(t); r < o.length; r++) {
              ...
              for (var s in t[a].prefix)
                if (
                  n.value.substr(0, t[a].prefix[s].length) === t[a].prefix[s] &&
        ...
        return {
          validate: function (e) {
            ...
            var o = Object.assign(
              ...
              s = e.l10n ? e.l10n.date.default : o.message,
            ...
            var V = parseInt(b, 10),
              ...
              w = parseInt(x, 10);
            if (!n(V, A, w)) return l;
            var F = new Date(V, A - 1, w);
            if (c) {
              var O = h.split(':');
              if (c.split(':').length !== O.length) return l;
              var C =
                  O.length > 0
                    ? O[0].length <= 2 && /^\d+$/.test(O[0])
                      ? parseInt(O[0], 10)
                      : -1
                    : 0,
                I =
                  O.length > 1
                    ? O[1].length <= 2 && /^\d+$/.test(O[1])
                      ? parseInt(O[1], 10)
                      : -1
                    : 0,
                _ =
                  O.length > 2
                    ? O[2].length <= 2 && /^\d+$/.test(O[2])
                      ? parseInt(O[2], 10)
                      : -1
                    : 0;
              if (-1 === C || -1 === I || -1 === _) return l;
              if (_ < 0 || _ > 60) return l;
              if (C < 0 || C >= 24 || (u && C > 12)) return l;
              if (I < 0 || I > 59) return l;
              F.setHours(m && 'PM' === m.toUpperCase() && C < 12 ? C + 12 : C),
                F.setMinutes(I),
                F.setSeconds(_);
            }
            var H = 'function' == typeof o.min ? o.min() : o.min,
              S = H instanceof Date ? H : H ? r(H, y, v) : F,
              k = 'function' == typeof o.max ? o.max() : o.max,
              P = k instanceof Date ? k : k ? r(k, y, v) : F,
              j = H instanceof Date ? a(S, o.format) : H,
              N = k instanceof Date ? a(P, o.format) : k;
            switch (!0) {
              case !!j && !N:
                return {
                  message: t(e.l10n ? e.l10n.date.min : s, j),
                  meta: { date: F },
                  valid: F.getTime() >= S.getTime(),
                };
              case !!N && !j:
                return {
                  message: t(e.l10n ? e.l10n.date.max : s, N),
                  meta: { date: F },
                  valid: F.getTime() <= P.getTime(),
                };
              case !!N && !!j:
                return {
                  message: t(e.l10n ? e.l10n.date.range : s, [j, N]),
                  meta: { date: F },
                  valid:
                    F.getTime() <= P.getTime() && F.getTime() >= S.getTime(),
                };
              default:
                return { message: ''.concat(s), meta: { date: F }, valid: !0 };
            }
          },
        };
      }),
            ...
            if (!0 === r.multiple || 'true' === ''.concat(r.multiple)) {
              for (
                var a = r.separator || /[,;]/,
                  s = (function (e, t) {
                    for (
                      var n = e.split(/"/), i = n.length, r = [], o = '', a = 0;
                      a < i;
                      a++
                    )
                      if (a % 2 == 0) {
          ...
          validate: function (t) {
            ...
            if (window.File && window.FileList && window.FileReader) {
              ...
              if (
                ...
                return { meta: { error: 'INVALID_NAME', name: i }, valid: !1 };
            }
            return { valid: !0 };
          },
        };
        ...
        return {
          validate: function (e) {
            ...
            switch (
              ...
              case !!o && !!a:
                d = t(
                  e.l10n ? i.message || e.l10n.stringLength.between : i.message,
                  [o, a],
                );
                break;
              case !!o:
  ...
  var Yt = Ut.exports,
    ...
    Gt = {
      ...
      choice: Ae.choice,
      creditCard: Ce.creditCard,
      date: Se.date,
      different: Ne.different,
      digits: De.digits,
      emailAddress: Be.emailAddress,
      file: Ze.file,
      greaterThan: Ke.greaterThan,
      ...
      regexp: _t.regexp,
      remote: Pt.remote,
      stringCase: Tt.stringCase,
      stringLength: zt.stringLength,
      uri: Yt.uri,
    };
  (e.Plugin = o.Plugin),
    (e.algorithms = o.algorithms),
    (e.formValidation = function (e, t) {
      var n = o.formValidation(e, t);
      return (
        Object.keys(Gt).forEach(function (e) {
          return n.registerValidator(e, Gt[e]);
        }),
        n
      );
    }),
