...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.plugins.Dependency = e(t.FormValidation)));
})(this, function (t) {
  'use strict';
  var e = function (t, o) {
    return (
  ...
  return (function (t) {
    function o(e) {
      ...
      return (
        (o.opts = e || {}),
        (o.triggerExecutedHandler = o.onTriggerExecuted.bind(o)),
        o
      );
    }
    return (
      ...
      (o.prototype.onTriggerExecuted = function (t) {
        if (this.isEnabled && this.opts[t.field])
          for (
            var e = 0, o = this.opts[t.field].split(' ');
            e < o.length;
            e++
          ) {
            var i = o[e].trim();
