  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.plugins.PasswordStrength = o(t.FormValidation)));
})(this, function (t) {
  'use strict';
  var o = function (t, e) {
    return (
    ...
    return (
      ...
      (e.prototype.checkPasswordStrength = function () {
        ...
        return {
          validate: function (o) {
            ...
            var i = zxcvbn(e),
              a = i.score,
              r = i.feedback.warning || 'The password is weak';
            return a < t.opts.minimalScore
              ? { message: r, meta: { message: r, score: a }, valid: !1 }
              : { meta: { message: r, score: a }, valid: !0 };
          },
        };
      }),
      (e.prototype.onValidatorValidated = function (t) {
        if (
          ...
          var o = t.result.meta.message,
            i = t.result.meta.score;
          this.opts.onValidated(t.result.valid, o, i);
        }
      }),
