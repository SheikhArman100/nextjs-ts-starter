...
!(function (o, e) {
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((o =
          'undefined' != typeof globalThis
            ? globalThis
            : o || self).FormValidation = o.FormValidation || {}),
        (o.FormValidation.plugins = o.FormValidation.plugins || {}),
        (o.FormValidation.plugins.Pure = e(
          o.FormValidation,
  ...
  return (function (o) {
    ...
    return (
      ...
      (e.prototype.onIconPlaced = function (o) {
        var e = o.element.getAttribute('type');
        if ('checkbox' === e || 'radio' === e) {
          var t = o.element.parentElement;
          n(o.iconElement, { 'fv-plugins-icon-check': !0 }),
            'LABEL' === t.tagName &&
              t.parentElement.insertBefore(o.iconElement, t.nextSibling);
        }
      }),
      e
    );
