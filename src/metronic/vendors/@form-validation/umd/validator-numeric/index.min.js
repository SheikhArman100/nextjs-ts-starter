  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((a =
        ...
        (a.FormValidation.validators.numeric = e(a.FormValidation)));
})(this, function (a) {
  'use strict';
    ...
    return {
      validate: function (a) {
        ...
        var t = Object.assign(
          ...
          o = ''.concat(a.value);
        o.substr(0, 1) === t.decimalSeparator
          ? (o = '0'.concat(t.decimalSeparator).concat(o.substr(1)))
          : o.substr(0, 2) === '-'.concat(t.decimalSeparator) &&
            (o = '-0'.concat(t.decimalSeparator).concat(o.substr(2)));
        var r = '.' === t.decimalSeparator ? '\\.' : t.decimalSeparator,
          i = '.' === t.thousandsSeparator ? '\\.' : t.thousandsSeparator,
          n = new RegExp(
            '^-?[0-9]{1,3}('.concat(i, '[0-9]{3})*(').concat(r, '[0-9]+)?$'),
          ),
          d = new RegExp(i, 'g');
        if (!n.test(o)) return { valid: !1 };
        i && (o = o.replace(d, '')), r && (o = o.replace(r, '.'));
        var c = parseFloat(o);
