  ...
  return (function (t) {
    ...
    return (
      ...
      (i.prototype.install = function () {
        ...
        var e =
          void 0 === window[i.LOADED_CALLBACK]
            ? function () {}
        ...
        window[i.LOADED_CALLBACK] = function () {
          ...
          n.setAttribute('type', 'hidden'),
            n.setAttribute('name', i.CAPTCHA_FIELD),
                      ...
                      window.grecaptcha
                        ...
                        .then(function (r) {
                          ...
                          o(t.opts.backendVerificationUrl, {
                            method: 'POST',
                            params: ((c = {}), (c[i.CAPTCHA_FIELD] = r), c),
                          })
                            .then(function (o) {
                              var n =
      ...
      (i.prototype.getScript = function () {
        ...
        return (
          ...
          'onload='
            .concat(i.LOADED_CALLBACK, '&render=')
            .concat(this.opts.siteKey)
            .concat(t)
        );
      }),
      (i.prototype.onIconPlaced = function (t) {
        t.field === i.CAPTCHA_FIELD && (t.iconElement.style.display = 'none');
      }),
      (i.CAPTCHA_FIELD = '___g-recaptcha-token___'),
      (i.LOADED_CALLBACK = '___reCaptcha3Loaded___'),
      i
    );
  })(t.Plugin);
});
