  ...
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        (global.FormValidation.plugins.Recaptcha = factory(
  ...
  var Recaptcha = /** @class */ (function (_super) {
              ...
              promise: function (input) {
                ...
                var value = _this.widgetIds.has(_this.opts.element)
                  ? window['grecaptcha'].getResponse(
                      _this.widgetIds.get(_this.opts.element),
                    )
                  : input.value;
                if (value === '') {
                  _this.captchaStatus = 'Invalid';
                  ...
                  return fetch(_this.opts.backendVerificationUrl, {
                    method: 'POST',
                    params:
                      ((_a = {}), (_a[Recaptcha.CAPTCHA_FIELD] = value), _a),
                  })
    ...
    Recaptcha.prototype.getScript = function () {
      ...
      return 'https://www.google.com/recaptcha/api.js?onload='
        .concat(Recaptcha.LOADED_CALLBACK, '&render=explicit')
        .concat(lang);
    };
