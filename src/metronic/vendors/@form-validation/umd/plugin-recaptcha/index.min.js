  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((e =
        ...
        (e.FormValidation.plugins.Recaptcha = t(e.FormValidation)));
})(this, function (e) {
  'use strict';
  var t = function (e, i) {
    return (
  ...
  return (function (e) {
    function a(t) {
      ...
      return (
        ...
        (i.opts = Object.assign({}, a.DEFAULT_OPTIONS, o(t))),
    ...
    return (
      ...
      (a.prototype.install = function () {
        ...
        var t =
          void 0 === window[a.LOADED_CALLBACK]
            ? function () {}
            : window[a.LOADED_CALLBACK];
        window[a.LOADED_CALLBACK] = function () {
          t();
          var o = {
              badge: e.opts.badge,
              callback: function () {
                '' === e.opts.backendVerificationUrl &&
                  ...
                  e.core.updateFieldStatus(a.CAPTCHA_FIELD, 'Valid'));
              },
              'error-callback': function () {
                (e.captchaStatus = 'Invalid'),
                  e.core.updateFieldStatus(a.CAPTCHA_FIELD, 'Invalid');
              },
              'expired-callback': function () {
                (e.captchaStatus = 'NotValidated'),
                  e.core.updateFieldStatus(a.CAPTCHA_FIELD, 'NotValidated');
              },
              sitekey: e.opts.siteKey,
              size: e.opts.size,
            },
            n = window.grecaptcha.render(e.opts.element, o);
          e.widgetIds.set(e.opts.element, n),
            e.core.addField(a.CAPTCHA_FIELD, {
              validators: {
                promise: {
                  message: e.opts.message,
                  promise: function (t) {
                    var o,
                      n = e.widgetIds.has(e.opts.element)
                        ? window.grecaptcha.getResponse(
                            e.widgetIds.get(e.opts.element),
                          )
                        : t.value;
                    return '' === n
                      ? ((e.captchaStatus = 'Invalid'),
                      ...
                      : '' === e.opts.backendVerificationUrl
                        ...
                        : 'Valid' === e.captchaStatus
                          ? Promise.resolve({ valid: !0 })
                          : i(e.opts.backendVerificationUrl, {
                              method: 'POST',
                              params: ((o = {}), (o[a.CAPTCHA_FIELD] = n), o),
                            })
                              .then(function (t) {
                                var i = 'true' === ''.concat(t.success);
                                return (
                                  (e.captchaStatus = i ? 'Valid' : 'Invalid'),
                                  Promise.resolve({ meta: t, valid: i })
                                );
                              })
                              .catch(function (t) {
                                return (
      ...
      (a.prototype.uninstall = function () {
        delete window[a.LOADED_CALLBACK],
        ...
        [].slice
          ...
          this.core.removeField(a.CAPTCHA_FIELD);
      }),
      (a.prototype.onEnabled = function () {
        this.core.enableValidator(a.CAPTCHA_FIELD, 'promise');
      }),
      (a.prototype.onDisabled = function () {
        this.core.disableValidator(a.CAPTCHA_FIELD, 'promise');
      }),
      (a.prototype.getScript = function () {
        var e = this.opts.language ? '&hl='.concat(this.opts.language) : '';
        return 'https://www.google.com/recaptcha/api.js?onload='
          .concat(a.LOADED_CALLBACK, '&render=explicit')
          .concat(e);
      }),
      (a.prototype.preValidate = function () {
        var e = this;
        if (
          this.isEnabled &&
          'invisible' === this.opts.size &&
          this.widgetIds.has(this.opts.element)
        ) {
          var t = this.widgetIds.get(this.opts.element);
          return 'Valid' === this.captchaStatus
            ? Promise.resolve()
            : new Promise(function (i, o) {
                window.grecaptcha.execute(t).then(function () {
                  e.timer && clearTimeout(e.timer),
                    (e.timer = window.setTimeout(i, 1e3));
                });
              });
        }
        return Promise.resolve();
      }),
      (a.prototype.onResetField = function (e) {
        if (
          e.field === a.CAPTCHA_FIELD &&
          this.widgetIds.has(this.opts.element)
        ) {
          var t = this.widgetIds.get(this.opts.element);
      ...
      (a.prototype.onIconPlaced = function (e) {
        if (e.field === a.CAPTCHA_FIELD)
          if ('invisible' === this.opts.size)
      ...
      (a.CAPTCHA_FIELD = 'g-recaptcha-response'),
      (a.DEFAULT_OPTIONS = {
      ...
      (a.LOADED_CALLBACK = '___reCaptchaLoaded___'),
      a
    );
  })(e.Plugin);
});
