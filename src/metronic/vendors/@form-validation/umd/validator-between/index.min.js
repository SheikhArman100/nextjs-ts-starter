  ...
  return function () {
    ...
    return {
      validate: function (o) {
        var t = o.value;
        if ('' === t) return { valid: !0 };
        var i = Object.assign({}, { inclusive: !0, message: '' }, n(o.options)),
          r = e(i.min),
          l = e(i.max);
        return i.inclusive
          ? {
              message: a(
                o.l10n ? i.message || o.l10n.between.default : i.message,
                [''.concat(r), ''.concat(l)],
              ),
              valid: parseFloat(t) >= r && parseFloat(t) <= l,
            }
          : {
              message: a(
                o.l10n ? i.message || o.l10n.between.notInclusive : i.message,
                [''.concat(r), ''.concat(l)],
              ),
              valid: parseFloat(t) > r && parseFloat(t) < l,
            };
