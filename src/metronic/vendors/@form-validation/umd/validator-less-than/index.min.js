  ...
  return function () {
    return {
      validate: function (e) {
        ...
        var o = Object.assign({}, { inclusive: !0, message: '' }, i(e.options)),
          n = parseFloat(''.concat(o.max).replace(',', '.'));
        return o.inclusive
          ? {
              message: a(
                e.l10n ? o.message || e.l10n.lessThan.default : o.message,
                ''.concat(n),
              ),
          ...
          : {
              message: a(
                e.l10n ? o.message || e.l10n.lessThan.notInclusive : o.message,
                ''.concat(n),
              ),
              valid: parseFloat(e.value) < n,
            };
