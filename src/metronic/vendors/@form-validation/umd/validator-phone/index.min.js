    ...
    : 'function' == typeof define && define.amd
      ...
      : (((s =
          'undefined' != typeof globalThis
            ? globalThis
            : s || self).FormValidation = s.FormValidation || {}),
        (s.FormValidation.validators = s.FormValidation.validators || {}),
        (s.FormValidation.validators.phone = e(s.FormValidation)));
})(this, function (s) {
  'use strict';
      ...
      validate: function (a) {
        ...
        switch (o.toUpperCase()) {
          ...
          case 'DE':
            ...
            break;
          case 'DK':
            n = /^(\+45|0045|\(45\))?\s?[2-9](\s?\d){7}$/.test(r);
            break;
          case 'ES':
            n = /^(?:(?:(?:\+|00)34\D?))?(?:5|6|7|8|9)(?:\d\D?){8}$/.test(r);
            break;
          case 'FR':
            n =
          ...
          case 'SK':
            ...
            break;
          case 'TH':
            n = /^0\(?([6|8-9]{2})*-([0-9]{3})*-([0-9]{4})$/.test(r);
            break;
          case 'VE':
            n =
