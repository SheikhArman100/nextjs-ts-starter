  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.validators.sedol = e()));
})(this, function () {
  'use strict';
  return function () {
    return {
      validate: function (t) {
        ...
        if (!/^[0-9A-Z]{7}$/.test(e)) return { valid: !1 };
        for (
          var a = [1, 3, 1, 7, 3, 9, 1], i = e.length, o = 0, n = 0;
          n < i - 1;
          n++
        )
          o += a[n] * parseInt(e.charAt(n), 36);
        return {
          valid: ''.concat((o = (10 - (o % 10)) % 10)) === e.charAt(i - 1),
        };
      },
    };
  };
