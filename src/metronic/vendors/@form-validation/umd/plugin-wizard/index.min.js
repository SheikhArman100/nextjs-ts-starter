...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['@form-validation/core', '@form-validation/plugin-excluded'], e)
      : (((t =
          'undefined' != typeof globalThis
            ? globalThis
            : t || self).FormValidation = t.FormValidation || {}),
        (t.FormValidation.plugins = t.FormValidation.plugins || {}),
        (t.FormValidation.plugins.Wizard = e(
          t.FormValidation,
  ...
  return (function (t) {
    function s(e) {
      ...
      return (
        ...
        (n.prevStepHandler = n.onClickPrev.bind(n)),
        (n.nextStepHandler = n.onClickNext.bind(n)),
        n
      );
    }
    return (
      ...
      (s.prototype.install = function () {
        ...
        (this.steps = [].slice.call(
          o.querySelectorAll(this.opts.stepSelector),
        )),
          (this.numSteps = this.steps.length),
          this.steps.forEach(function (t) {
            var e;
            i(t, (((e = {})[n.opts.stepClass] = !0), e));
          }),
          i(this.steps[0], (((t = {})[this.opts.activeStepClass] = !0), t)),
      ...
      (s.prototype.uninstall = function () {
        this.core.deregisterPlugin(s.EXCLUDED_PLUGIN),
      ...
      (s.prototype.getCurrentStep = function () {
        return this.currentStep;
      }),
      (s.prototype.goToPrevStep = function () {
        var t = this;
        if (this.isEnabled) {
      ...
      (s.prototype.goToNextStep = function () {
        var t = this;
        this.isEnabled &&
          this.core.validate().then(function (e) {
            if ('Valid' === e) {
              ...
              if (n >= t.numSteps) t.currentStep = t.numSteps - 1;
                ...
                (n = t.opts.isStepSkipped
                  ? t.stepIndexes.slice(n, t.numSteps).find(function (e, n) {
                      return !t.opts.isStepSkipped({
                        currentStep: t.currentStep,
                        numSteps: t.numSteps,
                        targetStep: e,
              ...
              t.onStepActive(),
                t.onStepValid(),
                n === t.numSteps && t.onValid();
            } else 'Invalid' === e && t.onStepInvalid();
          });
      }),
      (s.prototype.goToStep = function (t) {
        var e, n;
        this.isEnabled &&
          (i(
