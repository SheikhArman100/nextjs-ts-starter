(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(
          ['@form-validation/core', '@form-validation/plugin-excluded'],
          factory,
        )
      : ((global =
        ...
        (global.FormValidation.plugins.Wizard = factory(
          global.FormValidation,
          global.FormValidation.plugins,
        ))));
})(this, function (core, pluginExcluded) {
  'use strict';
  ...
  var Wizard = /** @class */ (function (_super) {
    ...
    Wizard.prototype.install = function () {
      ...
      this.steps.forEach(function (s) {
        var _a;
        classSet(s, ((_a = {}), (_a[_this.opts.stepClass] = true), _a));
      });
      classSet(
        this.steps[0],
        ((_a = {}), (_a[this.opts.activeStepClass] = true), _a),
      );
    ...
    Wizard.prototype.goToStep = function (index) {
      ...
      classSet(
        ...
        ((_a = {}), (_a[this.opts.activeStepClass] = false), _a),
      );
      classSet(
        this.steps[index],
        ((_b = {}), (_b[this.opts.activeStepClass] = true), _b),
      );
