  ...
  var i = (function () {
      ...
      (this.fields = {}),
        ...
        (this.filter = {
          ...
          execute: function (e, t, i) {
            ...
            for (
              var r = t, n = this.filters[e], s = n.length, o = 0;
              o < s;
              o++
            )
              r = n[o].apply(r, i);
    ...
    return (
      ...
      (e.prototype.executeValidator = function (e, t, i, r) {
        var n = this,
          s = this.elements[e],
          o = this.filter.execute('validator-name', i, [i, e]);
        if (
          ...
          return (
            this.emit('core.validator.validated', {
              ...
              elements: s,
              field: e,
              result: this.normalizeResult(e, o, { valid: !0 }),
              validator: o,
            }),
            Promise.resolve('Valid')
          );
        var l = this.validators[o],
          a = this.getElementValue(e, t, o);
      ...
      (e.prototype.getElementValue = function (e, t, i) {
        var r = (function (e, t, i, r) {
          ...
          if ('select' === s) {
            var o = i,
              l = o.selectedIndex;
            return l >= 0 ? o.options.item(l).value : '';
          }
          if ('input' === s) {
          ...
          case 'Valid':
            l.forEach(function (i) {
              return n.emit('core.validator.validated', {
                ...
                elements: s,
                field: e,
                result: { message: o[i].message, valid: !0 },
                validator: i,
              });
            }),
          ...
          case 'Invalid':
            l.forEach(function (i) {
              return n.emit('core.validator.validated', {
                ...
                elements: s,
                field: e,
                result: { message: o[i].message, valid: !1 },
                validator: i,
              });
            }),
              this.emit('core.element.validated', {
    ...
    s = {
      call: function (e, t) {
        ...
        if ('string' == typeof e) {
          ...
          for (
            var r = i.split('.'), n = r.pop(), s = window, o = 0, l = r;
            o < l.length;
            o++
          ) {
            s = s[l[o]];
    ...
    (e.formValidation = function (e, t) {
      ...
      return (
        Object.keys(o).forEach(function (e) {
          return r.registerValidator(e, o[e]);
        }),
        r
      );
    }),
