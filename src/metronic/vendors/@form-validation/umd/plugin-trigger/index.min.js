...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((e =
        ...
        (e.FormValidation.plugins.Trigger = t(e.FormValidation)));
})(this, function (e) {
  'use strict';
  var t = function (e, n) {
    return (
  ...
  return (function (e) {
    function n(t) {
      ...
      return (
        (n.defaultEvent = 'oninput' in o ? 'input' : 'keyup'),
    ...
    return (
      ...
      (n.prototype.prepareHandler = function (e, t) {
        ...
        t.forEach(function (t) {
          ...
          o.forEach(function (o) {
            var i = function (o) {
              return n.handleEvent(o, e, t);
            };
            n.handlers.push({ element: t, event: o, field: e, handler: i }),
      ...
      (n.prototype.handleEvent = function (e, t, n) {
        ...
        if (
          ...
          var i = function () {
              return o.core.validateElement(t, n).then(function (i) {
                o.core.emit('plugins.trigger.executed', {
                  element: n,
                  event: e,
                  field: t,
                });
            ...
            r = this.opts.delay[t] || this.opts.delay;
          if (0 === r) i();
          else {
            var l = this.timers.get(n);
            l && window.clearTimeout(l),
              this.timers.set(n, window.setTimeout(i, 1e3 * r));
          }
        }
      }),
        ...
        return (
          -1 !==
            [
              ...
              'reset',
              'submit',
            ].indexOf(o) || this.core.getElementValue(e, t).length >= n
        );
      }),
      n
    );
