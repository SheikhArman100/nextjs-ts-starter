  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.plugins.Turnstile = e(t.FormValidation)));
})(this, function (t) {
  'use strict';
  var e = function (t, i) {
    return (
  ...
  return (function (t) {
    function n(e) {
      ...
      return (
        ...
        (i.captchaContainer = ''),
        (i.opts = Object.assign({}, n.DEFAULT_OPTIONS, a(e))),
    ...
    return (
      ...
      (n.prototype.install = function () {
        ...
        window[n.LOADED_CALLBACK] = function () {
          ...
          t.widgetIds.set(t.captchaContainer, a),
                    ...
                    return '' === r
                      ...
                      : '' === t.opts.backendVerificationUrl
                        ...
                        : 'Valid' === t.captchaStatus
                          ? Promise.resolve({ valid: !0 })
                          : i(t.opts.backendVerificationUrl, {
                              method: 'POST',
                              params: ((a = {}), (a[n.CAPTCHA_FIELD] = r), a),
                            })
                              .then(function (e) {
        ...
        var a = this.getScript();
        if (!document.body.querySelector('script[src="'.concat(a, '"]'))) {
      ...
      (n.prototype.onEnabled = function () {
        this.core.enableValidator(n.CAPTCHA_FIELD, 'promise');
      }),
      (n.prototype.onDisabled = function () {
        this.core.disableValidator(n.CAPTCHA_FIELD, 'promise');
      }),
      (n.prototype.buildTurnstileRenderOptions = function () {
        var t = this;
        return {
          callback: function () {
            '' === t.opts.backendVerificationUrl &&
              ((t.captchaStatus = 'Valid'),
              t.core.updateFieldStatus(n.CAPTCHA_FIELD, 'Valid'));
          },
          'error-callback': function () {
            (t.captchaStatus = 'Invalid'),
              t.core.updateFieldStatus(n.CAPTCHA_FIELD, 'Invalid');
          },
          'expired-callback': function () {
            (t.captchaStatus = 'NotValidated'),
              t.core.updateFieldStatus(n.CAPTCHA_FIELD, 'NotValidated');
          },
      ...
      (n.prototype.getTurnstileInstance = function () {
      ...
      (n.prototype.preValidate = function () {
        return (
          this.isEnabled &&
      ...
      (n.prototype.onResetField = function (t) {
        if (
          t.field === n.CAPTCHA_FIELD &&
          this.widgetIds.has(this.captchaContainer)
        ) {
      ...
      (n.CAPTCHA_FIELD = 'cf-turnstile-response'),
      (n.DEFAULT_OPTIONS = {
      ...
      (n.LOADED_CALLBACK = '___turnstileLoaded___'),
      n
    );
  })(t.Plugin);
});
