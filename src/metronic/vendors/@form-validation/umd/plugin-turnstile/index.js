(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        (global.FormValidation.plugins.Turnstile = factory(
  ...
  var Turnstile = /** @class */ (function (_super) {
    ...
    function Turnstile(opts) {
      ...
      _this.captchaContainer = _this.opts.element.startsWith('#')
        ? _this.opts.element
        : '#'.concat(_this.opts.element);
      return _this;
    }
    Turnstile.prototype.install = function () {
      ...
      var loadPrevCaptcha =
        typeof window[Turnstile.LOADED_CALLBACK] === 'undefined'
          ? function () {}
          : window[Turnstile.LOADED_CALLBACK];
      window[Turnstile.LOADED_CALLBACK] = function () {
        ...
        var widgetId = _this
          ...
          .render(_this.captchaContainer, _this.buildTurnstileRenderOptions());
            ...
            promise: {
              ...
              promise: function (input) {
                ...
                var value = _this.widgetIds.has(_this.captchaContainer)
                  ? _this
                      .getTurnstileInstance()
                      .getResponse(_this.widgetIds.get(_this.captchaContainer))
                  : input.value;
                if (value === '') {
                ...
                return fetch(_this.opts.backendVerificationUrl, {
                  method: 'POST',
                  params:
                    ((_a = {}), (_a[Turnstile.CAPTCHA_FIELD] = value), _a),
                })
    ...
    Turnstile.prototype.uninstall = function () {
      ...
      var scripts = [].slice.call(
        document.body.querySelectorAll('script[src="'.concat(src, '"]')),
      );
    ...
    Turnstile.prototype.onResetField = function (e) {
      if (
        e.field === Turnstile.CAPTCHA_FIELD &&
        this.widgetIds.has(this.captchaContainer)
      ) {
