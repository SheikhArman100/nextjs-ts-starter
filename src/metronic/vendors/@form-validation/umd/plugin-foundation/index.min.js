...
!(function (e, o) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = o(require('@form-validation/plugin-framework')))
    : 'function' == typeof define && define.amd
      ? define(['@form-validation/plugin-framework'], o)
      : (((e =
          'undefined' != typeof globalThis
            ? globalThis
            : e || self).FormValidation = e.FormValidation || {}),
        (e.FormValidation.plugins = e.FormValidation.plugins || {}),
        (e.FormValidation.plugins.Foundation = o(e.FormValidation.plugins)));
})(this, function (e) {
  'use strict';
  var o = function (e, n) {
    return (
      ...
      (n.prototype.onIconPlaced = function (e) {
        ...
        if ('checkbox' === o || 'radio' === o) {
          ...
          if ('LABEL' === n.nodeName)
            ...
            t &&
              'LABEL' === t.nodeName &&
              t.parentNode.insertBefore(e.iconElement, t.nextSibling);
          }
        }
      }),
      n
