  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((t =
        ...
        (t.FormValidation.plugins.AutoFocus = o(
          t.FormValidation,
    ...
    return (
      ...
      (n.prototype.install = function () {
        this.core
          ...
          .registerPlugin(n.FIELD_STATUS_PLUGIN, new o.FieldStatus());
      }),
      (n.prototype.uninstall = function () {
        this.core
          .off('core.form.invalid', this.invalidFormHandler)
          .deregisterPlugin(n.FIELD_STATUS_PLUGIN);
      }),
      (n.prototype.onEnabled = function () {
        this.core.enablePlugin(n.FIELD_STATUS_PLUGIN);
      }),
      (n.prototype.onDisabled = function () {
        this.core.disablePlugin(n.FIELD_STATUS_PLUGIN);
      }),
      (n.prototype.onFormInvalid = function () {
        if (this.isEnabled) {
          var t = this.core.getPlugin(n.FIELD_STATUS_PLUGIN).getStatuses(),
            o = Object.keys(this.core.getFields()).filter(function (o) {
              return 'Invalid' === t.get(o);
            });
          if (o.length > 0) {
            var i = o[0],
              e = this.core.getElements(i);
            if (e.length > 0) {
              var r = e[0],
                l = { firstElement: r, field: i };
              this.core.emit('plugins.autofocus.prefocus', l),
                this.opts.onPrefocus(l),
                r.focus();
            }
          }
        }
      }),
      (n.FIELD_STATUS_PLUGIN = '___autoFocusFieldStatus'),
      n
    );
  })(t.Plugin);
});
