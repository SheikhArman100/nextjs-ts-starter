  ...
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        (global.FormValidation.plugins.MandatoryIcon = factory(
  ...
  var MandatoryIcon = /** @class */ (function (_super) {
    ...
    MandatoryIcon.prototype.onEnabled = function () {
      ...
      this.icons.forEach(function (_element, iconElement, _map) {
        var _a;
        classSet(iconElement, ((_a = {}), (_a[_this.opts.icon] = true), _a));
      });
    };
    MandatoryIcon.prototype.onDisabled = function () {
      ...
      this.icons.forEach(function (_element, iconElement, _map) {
        var _a;
        classSet(iconElement, ((_a = {}), (_a[_this.opts.icon] = false), _a));
      });
    };
    MandatoryIcon.prototype.onIconPlaced = function (e) {
      ...
      if (
        ...
        var elementArray =
          'checkbox' === type || 'radio' === type ? [elements[0]] : elements;
        for (
          var _i = 0, elementArray_1 = elementArray;
          _i < elementArray_1.length;
          _i++
        ) {
          ...
          if (this.core.getElementValue(e.field, ele) === '') {
            ...
            classSet(
              e.iconElement,
              ((_a = {}), (_a[this.opts.icon] = this.isEnabled), _a),
            );
          }
        }
      }
    ...
    MandatoryIcon.prototype.onIconSet = function (e) {
      ...
      if (
        ...
        classSet(icon, ((_a = {}), (_a[this.opts.icon] = this.isEnabled), _a));
      }
    };
