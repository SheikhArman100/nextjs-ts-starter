  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((e =
        ...
        (e.FormValidation.plugins.Bootstrap5 = t(
          e.FormValidation,
  ...
  return (function (e) {
    ...
    return (
      ...
      (t.prototype.handleElementValidated = function (e) {
        ...
        if (
          ...
          o(n, 'form-check') &&
            ...
            i(n, { 'is-invalid': !e.valid, 'is-valid': e.valid });
        }
      }),
      (t.prototype.onIconPlaced = function (e) {
        i(e.element, { 'fv-plugins-icon-input': !0 });
        ...
        o(t, 'input-group') &&
          ...
          e.element.nextElementSibling &&
            ...
            i(e.iconElement, { 'fv-plugins-icon-input-group': !0 }));
        var n = e.element.getAttribute('type');
        if ('checkbox' === n || 'radio' === n) {
          var l = t.parentElement;
          o(t, 'form-check')
            ? (i(e.iconElement, { 'fv-plugins-icon-check': !0 }),
              t.parentElement.insertBefore(e.iconElement, t.nextSibling))
            : o(t.parentElement, 'form-check') &&
              (i(e.iconElement, { 'fv-plugins-icon-check': !0 }),
              l.parentElement.insertBefore(e.iconElement, l.nextSibling));
        }
      }),
      (t.prototype.onMessagePlaced = function (e) {
        ...
        if (o(t, 'input-group'))
          return (
            t.appendChild(e.messageElement), void i(t, { 'has-validation': !0 })
          );
        var n = e.element.getAttribute('type');
        ('checkbox' !== n && 'radio' !== n) ||
          !o(e.element, 'form-check-input') ||
