  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : (((e =
        ...
        (e.FormValidation.validators.creditCard = t(e.FormValidation)));
})(this, function (e) {
  'use strict';
  var t = e.algorithms.luhn,
    i = {
  ...
  return function () {
    return {
      validate: function (e) {
        ...
        if (!t(r)) return { meta: { type: null }, valid: !1 };
        for (var l = 0, n = Object.keys(i); l < n.length; l++) {
          var a = n[l];
          for (var f in i[a].prefix)
            if (
              e.value.substr(0, i[a].prefix[f].length) === i[a].prefix[f] &&
              -1 !== i[a].length.indexOf(r.length)
            )
