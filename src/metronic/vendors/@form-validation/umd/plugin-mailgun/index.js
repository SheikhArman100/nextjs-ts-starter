(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(
          ['@form-validation/core', '@form-validation/plugin-alias'],
          factory,
        )
      : ((global =
        ...
        (global.FormValidation.plugins.Mailgun = factory(
          global.FormValidation,
          global.FormValidation.plugins,
        ))));
})(this, function (core, pluginAlias) {
  'use strict';
  ...
  var Mailgun = /** @class */ (function (_super) {
    ...
    Mailgun.prototype.install = function () {
      ...
      this.core
        .registerPlugin(Mailgun.ALIAS_PLUGIN, new pluginAlias.Alias(aliasOpts))
