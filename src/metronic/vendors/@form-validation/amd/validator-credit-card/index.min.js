    ...
    (e.creditCard = function () {
      return {
        validate: function (e) {
          ...
          if (!r(t)) return { meta: { type: null }, valid: !1 };
          for (var n = 0, i = Object.keys(l); n < i.length; n++) {
            var f = i[n];
            for (var a in l[f].prefix)
              if (
                e.value.substr(0, l[f].prefix[a].length) === l[f].prefix[a] &&
                -1 !== l[f].length.indexOf(t.length)
              )
