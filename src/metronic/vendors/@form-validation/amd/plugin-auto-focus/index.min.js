    ...
    return (
      ...
      (o.prototype.install = function () {
        this.core
          ...
          .registerPlugin(o.FIELD_STATUS_PLUGIN, new n.FieldStatus());
      }),
      (o.prototype.uninstall = function () {
        this.core
          .off('core.form.invalid', this.invalidFormHandler)
          .deregisterPlugin(o.FIELD_STATUS_PLUGIN);
      }),
      (o.prototype.onEnabled = function () {
        this.core.enablePlugin(o.FIELD_STATUS_PLUGIN);
      }),
      (o.prototype.onDisabled = function () {
        this.core.disablePlugin(o.FIELD_STATUS_PLUGIN);
      }),
      (o.prototype.onFormInvalid = function () {
        if (this.isEnabled) {
          var t = this.core.getPlugin(o.FIELD_STATUS_PLUGIN).getStatuses(),
            n = Object.keys(this.core.getFields()).filter(function (o) {
              return 'Invalid' === t.get(o);
            });
          if (n.length > 0) {
            var e = n[0],
              i = this.core.getElements(e);
            if (i.length > 0) {
              var r = i[0],
                s = { firstElement: r, field: e };
      ...
      (o.FIELD_STATUS_PLUGIN = '___autoFocusFieldStatus'),
      o
    );
  })(o.Plugin);
  t.AutoFocus = i;
