    ...
    return {
      validate: function (e) {
        ...
        var a = Object.assign(
          ...
          l = a.requireGlobalDomain ? i : t;
        if (!0 === a.multiple || 'true' === ''.concat(a.multiple)) {
          for (
            var n = a.separator || /[,;]/,
              s = (function (e, a) {
                for (
                  var r = e.split(/"/), t = r.length, i = [], l = '', n = 0;
                  n < t;
                  n++
                )
                  if (n % 2 == 0) {
                    ...
                    if (1 === u) l += s[0];
                      ...
                      i.push(l + s[0]);
                      for (var o = 1; o < u - 1; o++) i.push(s[o]);
                      l = s[u - 1];
                    }
                  } else (l += '"' + r[n]), n < t - 1 && (l += '"');
                return i.push(l), i;
            ...
            if (!l.test(s[o])) return { valid: !1 };
          return { valid: !0 };
        }
        return { valid: l.test(e.value) };
      },
    };
  };
});
