  ...
  e.remote = function () {
    ...
    return {
      validate: function (a) {
        ...
        var i = Object.assign({}, e, r(a.options)),
          o = i.data;
        'function' == typeof i.data && (o = i.data.call(this, a)),
          'string' == typeof o && (o = JSON.parse(o)),
          (o[i.name || a.field] = a.value);
        var n = 'function' == typeof i.url ? i.url.call(this, a) : i.url;
        return t(n, {
