        ...
        return {
          validate: function (e) {
            ...
            var H = 'function' == typeof o.min ? o.min() : o.min,
              ...
              P = k instanceof Date ? k : k ? r(k, y, v) : O,
            ...
            switch (!0) {
              ...
              case !!N && !!j:
                return {
                  ...
                  meta: { date: O },
                  valid:
                    O.getTime() <= P.getTime() && O.getTime() >= S.getTime(),
                };
              default:
                return { message: ''.concat(s), meta: { date: O }, valid: !0 };
            }
          },
        };
      }),
