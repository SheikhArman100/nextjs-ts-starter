...
define(['exports', '@form-validation/core'], function (e, t) {
  ...
  var n = (function (e) {
    ...
    return (
      ...
      (t.prototype.createPluginInstance = function (e, t) {
        for (
          var a = e.split('.'), n = window || this, r = 0, i = a.length;
          r < i;
          r++
        )
          n = n[a[r]];
      ...
      (t.prototype.parsePlugins = function () {
        ...
        Object.keys(i).forEach(function (e) {
          ...
          if (n && r) {
            ...
            var s = t.createPluginInstance(r, a);
            t.core.registerPlugin(e, s);
          }
        });
      }),
      (t.prototype.isEmptyOption = function (e) {
        var t = e.validators;
        return 0 === Object.keys(t).length && t.constructor === Object;
      }),
      (t.prototype.parseElement = function (e) {
        for (
          var t = new RegExp(
          ...
          if (this.opts.html5Input)
            switch (!0) {
              ...
              case 'pattern' === s:
                ...
                break;
              case 'required' === s:
                n.notEmpty = Object.assign({}, { enabled: !0 }, n.notEmpty);
                break;
              case 'type' === s && 'color' === o:
              ...
              case 'type' === s && 'email' === o:
                ...
                break;
              case 'type' === s && 'url' === o:
                n.uri = Object.assign({}, { enabled: !0 }, n.uri);
                break;
              case 'type' === s && 'range' === o:
                n.between = Object.assign(
                  {},
                  {
                    enabled: !0,
          ...
          if (l && 4 === l.length) {
            ...
            n[d] || (n[d] = {}),
              l[3]
                ? (n[d][this.toCamelCase(l[3])] = this.normalizeValue(o))
                : (!0 === n[d].enabled && !1 === n[d].enabled) ||
                  (n[d].enabled = '' === o || 'true' === o);
          }
        }
        return { validators: n };
      }),
      ...
      (t.prototype.toUpperCase = function (e) {
        return e.charAt(1).toUpperCase();
      }),
      (t.prototype.toCamelCase = function (e) {
