    ...
    return {
      validate: function (e) {
        ...
        if (window.File && window.FileList && window.FileReader) {
          var o = e.element.files,
            s = o.length,
            l = 0;
          if (
            e.options.maxFiles &&
            s > parseInt(''.concat(e.options.maxFiles), 10)
          )
            return { meta: { error: 'INVALID_MAX_FILES' }, valid: !1 };
          if (
            e.options.minFiles &&
            s < parseInt(''.concat(e.options.minFiles), 10)
          )
          ...
          for (var I = {}, p = 0; p < s; p++) {
            if (
              ...
              e.options.minSize &&
                o[p].size < parseInt(''.concat(e.options.minSize), 10))
            )
              return {
            ...
            if (
              e.options.maxSize &&
              o[p].size > parseInt(''.concat(e.options.maxSize), 10)
            )
              return {
            ...
            if (
              ...
              !e.options.validateFileName(t(o[p].name))
            )
              return {
          ...
          if (
            ...
            l > parseInt(''.concat(e.options.maxTotalSize), 10)
          )
            return {
              meta: Object.assign(
                {},
          ...
          if (
            ...
            l < parseInt(''.concat(e.options.minTotalSize), 10)
          )
            return {
              meta: Object.assign(
                {},
          ...
          if (
            ((n = t(e.value)),
            e.options.validateFileName && !e.options.validateFileName(n))
          )
