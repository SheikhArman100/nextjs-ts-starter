...
define(['exports', '@form-validation/core'], function (t, e) {
  ...
  var o = (function (t) {
    function e(e) {
      ...
      return (r.messageFilter = r.getMessage.bind(r)), r;
    }
    return (
      (function (t, e) {
      ...
      (e.prototype.getMessage = function (t, e, r) {
        if (!this.isEnabled) return '';
        if (this.opts[e] && this.opts[e][r]) {
          var o = this.opts[e][r],
            n = typeof o;
          if ('object' === n && o[t]) return o[t];
          if ('function' === n) {
            var i = o.apply(this, [e, r]);
            return i && i[t] ? i[t] : '';
          }
        }
        return '';
