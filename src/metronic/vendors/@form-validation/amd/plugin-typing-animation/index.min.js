...
define(['exports', '@form-validation/core'], function (t, e) {
  ...
  var o = (function (t) {
    function e(e) {
      ...
      return (n.opts = Object.assign({}, { autoPlay: !0 }, e)), n;
    }
    return (
      (function (t, e) {
      ...
      (e.prototype.animate = function (t) {
        ...
        var n = this.fields[t],
          o = this.core.getElements(n)[0],
          r = o.getAttribute('type'),
          i = this.opts.data[n];
        return 'checkbox' === r || 'radio' === r
          ? ((o.checked = !0),
            o.setAttribute('checked', 'true'),
            this.core.revalidateField(n).then(function (n) {
              return e.animate(t + 1);
            }))
          : i
            ? new Promise(function (r) {
                return new Typed(o, {
                  ...
                  onStringTyped: function (t, r) {
                    (o.value = i[t]), e.core.revalidateField(n);
                  },
                  strings: i,
                  typeSpeed: 100,
                });
