...
define(['exports', '@form-validation/core'], function (s, e) {
  'use strict';
  ...
  s.phone = function () {
    ...
    return {
      validate: function (e) {
        ...
        var d = Object.assign({}, { message: '' }, a(e.options)),
          r = e.value.trim(),
          n = r.substr(0, 2);
        if (
          !(n =
        ...
        return {
          message: t(
            e.l10n && e.l10n.phone
              ? d.message || e.l10n.phone.country
              : d.message,
            e.l10n && e.l10n.phone && e.l10n.phone.countries
              ? e.l10n.phone.countries[n]
              : n,
          ),
          valid: c,
        };
