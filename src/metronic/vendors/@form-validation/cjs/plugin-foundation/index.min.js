...
'use strict';
var e = require('@form-validation/plugin-framework'),
  t = function (e, o) {
    return (
      (t =
  ...
  return (
    ...
    (o.prototype.onIconPlaced = function (e) {
      ...
      if ('checkbox' === t || 'radio' === t) {
        var o = e.iconElement.nextSibling;
        if ('LABEL' === o.nodeName)
          o.parentNode.insertBefore(e.iconElement, o.nextSibling);
        else if ('#text' === o.nodeName) {
          var r = o.nextSibling;
          r &&
            'LABEL' === r.nodeName &&
            r.parentNode.insertBefore(e.iconElement, r.nextSibling);
        }
      }
    }),
    o
