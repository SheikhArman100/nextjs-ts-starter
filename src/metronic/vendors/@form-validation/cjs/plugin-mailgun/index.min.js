...
var e = require('@form-validation/core'),
  t = require('@form-validation/plugin-alias'),
  i = function (e, t) {
    return (
      (i =
...
var s = e.utils.removeUndefined,
  n = (function (e) {
    function n(t) {
      var i = e.call(this, t) || this;
      return (
        (i.opts = Object.assign({}, { suggestion: !1 }, s(t))),
    ...
    return (
      ...
      (n.prototype.install = function () {
        ...
        this.core
          .registerPlugin(n.ALIAS_PLUGIN, new t.Alias({ mailgun: 'remote' }))
      ...
      (n.ALIAS_PLUGIN = '___mailgunAlias'),
      n
    );
  })(e.Plugin);
exports.Mailgun = n;
