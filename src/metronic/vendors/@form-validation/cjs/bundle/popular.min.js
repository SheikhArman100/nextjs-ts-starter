      ...
      var t = {
          luhn: function (e) {
            for (
              ...
              (r += n[i][parseInt(e.charAt(t), 10)]), (i = 1 - i);
            return r % 10 == 0 && r > 0;
          },
          ...
          mod37And36: function (e, t) {
            ...
            for (
              var n = e.length, i = t.length, r = Math.floor(i / 2), o = 0;
              o < n;
              o++
            )
        ...
        i = (function () {
            ...
            (this.fields = {}),
              ...
              (this.filter = {
                ...
                execute: function (e, t, n) {
                  ...
                  for (
                    var i = t, r = this.filters[e], o = r.length, a = 0;
                    a < o;
                    a++
                  )
                    i = r[a].apply(i, n);
          ...
          return (
            ...
            (e.prototype.validateField = function (e) {
              ...
              if ('Valid' === n || 'Invalid' === n) return Promise.resolve(n);
              ...
              return 'radio' === r || 'checkbox' === r || 1 === i.length
                ? this.validateElement(e, i[0])
                : Promise.all(
                    i.map(function (n) {
            ...
            (e.prototype.validateElement = function (e, t) {
              ...
              return this.waterfall(o)
                .then(function (r) {
                  ...
                  return (
                    ('radio' !== a && 'checkbox' !== a && 1 !== i.length) ||
                      n.emit(o ? 'core.field.valid' : 'core.field.invalid', e),
            ...
            (e.prototype.executeValidator = function (e, t, n, i) {
              ...
              if (
                !this.filter.execute('field-should-validate', !0, [e, t, l, n])
              )
                return (
                ...
                case 'Valid':
                  s.forEach(function (n) {
                    return r.emit('core.validator.validated', {
                      ...
                      elements: o,
                      field: e,
                      result: { message: a[n].message, valid: !0 },
                      validator: n,
                    });
                  }),
                ...
                case 'Invalid':
                  s.forEach(function (n) {
                    return r.emit('core.validator.validated', {
                      ...
                      elements: o,
                      field: e,
                      result: { message: a[n].message, valid: !1 },
                      validator: n,
                    });
                  }),
                    this.emit('core.element.validated', {
            ...
            (e.prototype.updateValidatorOption = function (e, t, n, i) {
              return (
                this.fields[e] &&
                  ...
                  (this.fields[e].validators[t][n] = i),
                this
              );
            }),
        ...
        a = {
          call: function (e, t) {
            ...
            if ('string' == typeof e) {
              ...
              for (
                var i = n.split('.'), r = i.pop(), o = window, a = 0, s = i;
                a < s.length;
                a++
              )
                o = o[s[a]];
          ...
          closest: function (e, t) {
            for (var n = e; n && !o(n, t); ) n = n.parentElement;
            return n;
          },
          fetch: function (e, t) {
        ...
        t = (function (t) {
          ...
          return (
            ...
            (n.prototype.parseOptions = function () {
              ...
              return (
                [].slice
                  .call(r.querySelectorAll('[name], ['.concat(t, 'field]')))
                  .forEach(function (i) {
                    var r = e.parseElement(i);
                    if (!e.isEmptyOption(r)) {
                      var o =
                        i.getAttribute('name') ||
                        i.getAttribute(''.concat(t, 'field'));
                      n[o] = Object.assign({}, n[o], r);
                    }
                  }),
                Object.keys(n).forEach(function (e) {
                  Object.keys(n[e].validators).forEach(function (t) {
                    (n[e].validators[t].enabled =
                      n[e].validators[t].enabled || !1),
                      i[e] &&
                        i[e].validators &&
                        i[e].validators[t] &&
                        Object.assign(n[e].validators[t], i[e].validators[t]);
                  });
                }),
                Object.assign({}, i, n)
              );
            ...
            (n.prototype.createPluginInstance = function (e, t) {
              for (
                var n = e.split('.'), i = window || this, r = 0, o = n.length;
                r < o;
                r++
              )
                i = i[n[r]];
            ...
            (n.prototype.parseElement = function (e) {
              for (
                ...
                if (l && 4 === l.length) {
                  ...
                  i[d] || (i[d] = {}),
                    l[3]
                      ? (i[d][this.toCamelCase(l[3])] = this.normalizeValue(s))
                      : (!0 === i[d].enabled && !1 === i[d].enabled) ||
                        (i[d].enabled = '' === s || 'true' === s);
                }
              }
              return { validators: i };
            }),
          ...
          return (
            ...
            (n.prototype.onTriggerExecuted = function (e) {
              if (this.isEnabled && this.opts[e.field])
                for (
                  var t = 0, n = this.opts[e.field].split(' ');
                  t < n.length;
                  t++
                ) {
                  var i = n[t].trim();
      ...
      var e = a,
        ...
        i = (function (e) {
          function i(t) {
            ...
            return (
              (r.opts = Object.assign({}, { excluded: i.defaultIgnore }, n(t))),
          ...
          return (
            ...
            (i.prototype.ignoreValidation = function (e, t, n) {
              return (
                !!this.isEnabled && this.opts.excluded.apply(this, [e, t, n])
              );
            }),
            i
          );
        })(e.Plugin);
      return (M.Excluded = i), M;
    })())
  : (D.exports = (function () {
      if (T) return R;
      T = 1;
        ...
        i = (function (e) {
          function i(t) {
            ...
            return (
              ...
              (n.validatorNotValidatedHandler =
                n.onValidatorNotValidated.bind(n)),
              n
            );
          }
          return (
            ...
            (i.getClosestContainer = function (e, t, n) {
              for (
                var i = e;
                i && i !== t && ((i = i.parentElement), !n.test(i.className));
            ...
            (i.prototype.onFieldRemoved = function (e) {
              ...
              if (e.elements.length && e.field) {
                ...
                ('radio' === n || 'checkbox' === n
                  ...
                  if (t.messages.has(e)) {
                    var n = t.messages.get(e);
                    n.parentNode.removeChild(n), t.messages.delete(e);
                  }
                });
              }
            }),
            ...
            (i.prototype.prepareElementContainer = function (e, t, i) {
              ...
              } else r = this.opts.container(e, t);
          ...
          return (
                  ...
                  (this.core.registerPlugin(
                    ...
                    new t.Message({
                      ...
                      container: function (e, i) {
                        var o =
                            'string' == typeof n.opts.rowSelector
                              ? n.opts.rowSelector
                              : n.opts.rowSelector(e, i),
                          a = r(i, o);
            ...
            (o.prototype.onFieldAdded = function (e) {
              ...
              n &&
                (n.forEach(function (e) {
                  var n,
                    r = t.containers.get(e);
                  r &&
                    (i(
                      r,
                      (((n = {})[t.opts.rowInvalidClass] = !1),
            ...
            (o.prototype.removeClasses = function (e, t) {
              var n,
                ...
                a = 'radio' === o || 'checkbox' === o ? t[0] : e;
              t.forEach(function (e) {
                var t;
                i(
                  e,
                  (((t = {})[r.opts.eleValidClass] = !1),
            ...
            (o.prototype.onElementValidated = function (e) {
              var t,
                ...
                s = 'radio' === a || 'checkbox' === a ? o[0] : e.element;
              o.forEach(function (t) {
                var n;
                i(
                  t,
                  (((n = {})[r.opts.eleValidClass] = e.valid),
      ...
      var e = a,
        ...
        i = (function (e) {
          function i(t) {
            ...
            return (
              (i.invalidFields = new Map()),
              (i.opts = Object.assign({}, { enabled: !0 }, n(t))),
            ...
            (i.prototype.shouldValidate = function (e, t, n, i) {
              return (
                ...
                !(
                  ...
                  -1 === this.invalidFields.get(t).indexOf(i)
                )
              );
            }),
            (i.prototype.onValidatorValidated = function (e) {
              ...
              e.result.valid && n >= 0
                ? t.splice(n, 1)
                : e.result.valid || -1 !== n || t.push(e.validator),
            ...
            (n.prototype.handleClickEvent = function (e) {
              ...
              if (((this.isButtonClicked = !0), t instanceof HTMLElement))
                if (this.opts.aspNetButton && !0 === this.isFormValid);
                  ...
                  n &&
                    i &&
                    (this.hiddenClickedEle.setAttribute('name', n),
        ...
        i = (function (e) {
          ...
          return (
            ...
            (i.prototype.onIconPlaced = function (e) {
              var t = this;
              n(e.iconElement, { 'fv-plugins-tooltip-icon': !0 }),
            ...
            (i.prototype.show = function (e, t) {
              if (
                ...
                n(this.tip, { 'fv-plugins-tooltip--hide': !1 }),
                  (this.tip.innerHTML =
                ...
                switch (this.opts.placement) {
                  case 'bottom':
                    (s = i.top + i.height), (l = i.left + i.width / 2 - a / 2);
                    break;
                  case 'bottom-left':
                    (s = i.top + i.height), (l = i.left);
                    break;
                  case 'bottom-right':
                    (s = i.top + i.height), (l = i.left + i.width - a);
                    break;
                  case 'left':
                    (s = i.top + i.height / 2 - o / 2), (l = i.left - a);
                    break;
                  case 'right':
                    (s = i.top + i.height / 2 - o / 2), (l = i.left + i.width);
                    break;
                  case 'top-left':
                    (s = i.top - o), (l = i.left);
                    break;
                  case 'top-right':
                    (s = i.top - o), (l = i.left + i.width - a);
                    break;
                  default:
                    (s = i.top - o), (l = i.left + i.width / 2 - a / 2);
                }
                (s +=
                  window.scrollY ||
                  ...
                  this.tip.setAttribute(
                    'style',
                    'top: '.concat(s, 'px; left: ').concat(l, 'px'),
                  );
              }
            }),
            (i.prototype.hide = function () {
              this.isEnabled && n(this.tip, { 'fv-plugins-tooltip--hide': !0 });
            }),
            i
          );
        })(e.Plugin);
      return (Fe.Tooltip = i), Fe;
    })())
  : (Ae.exports = (function () {
      if (Ce) return _e;
      Ce = 1;
      ...
      var e = function (t, n) {
        ...
        t = (function (t) {
          function n(e) {
            ...
            return (
              (n.defaultEvent = 'oninput' in i ? 'input' : 'keyup'),
              (n.opts = Object.assign(
                {},
          ...
          return (
            ...
            (n.prototype.prepareHandler = function (e, t) {
              ...
              t.forEach(function (t) {
                var i = [];
                if (n.opts.event && !1 === n.opts.event[e]) i = [];
                else if (
                  n.opts.event &&
                  n.opts.event[e] &&
              ...
              return (
                -1 !==
                  [
                    ...
                    'reset',
                    'submit',
                  ].indexOf(i) || this.core.getElementValue(e, t).length >= n
              );
            }),
            n
          );
        })(a.Plugin);
      return (Se.Trigger = t), Se;
    })())
  : (Ne.exports = (function () {
      if (Pe) return ke;
      Pe = 1;
          ...
          return {
            validate: function (i) {
              ...
              return o.inclusive
                ? {
                    message: t(
                      i.l10n ? o.message || i.l10n.between.default : o.message,
                      [''.concat(a), ''.concat(s)],
                    ),
                ...
                : {
                    message: t(
                      i.l10n
                        ? o.message || i.l10n.between.notInclusive
                        : o.message,
                      [''.concat(a), ''.concat(s)],
                    ),
                    valid: parseFloat(r) > a && parseFloat(r) < s,
        ...
        (Je.callback = function () {
          return {
            validate: function (t) {
              ...
              return 'boolean' == typeof n ? { valid: n } : n;
            },
          };
        }),
        Je
        ...
        (nt.choice = function () {
          return {
            validate: function (t) {
              ...
              switch (!0) {
                case !!i && !!r:
                  o = e(t.l10n ? t.l10n.choice.between : t.options.message, [
                    i,
                    r,
                  ]);
                  break;
...
'production' === process.env.NODE_ENV
        ...
        (lt.creditCard = function () {
          return {
            validate: function (n) {
              ...
              if (!e(i)) return { meta: { type: null }, valid: !1 };
              for (var r = 0, o = Object.keys(t); r < o.length; r++) {
                var a = o[r];
                for (var s in t[a].prefix)
                  if (
                    n.value.substr(0, t[a].prefix[s].length) ===
                      t[a].prefix[s] &&
                    -1 !== t[a].length.indexOf(i.length)
                  )
                    return { meta: { type: a }, valid: !0 };
              }
              return { meta: { type: null }, valid: !1 };
            },
          };
  ...
  : (st.exports = (function () {
      ...
      return (
        (ct.CREDIT_CARD_TYPES = t),
        (ct.creditCard = function () {
          return {
            validate: function (n) {
              if ('' === n.value) return { meta: { type: null }, valid: !0 };
              if (/[^0-9-\s]+/.test(n.value))
          ...
          return {
            validate: function (e) {
                ...
                (-1 !== p.indexOf('/')
                  ...
                  : -1 !== p.indexOf('-')
                    ...
                    : -1 !== p.indexOf('.')
                      ? '.'
                      : '/');
              if (null === v || -1 === p.indexOf(v)) return l;
              var g = p.split(v),
                y = d[0].split(v);
              if (g.length !== y.length) return l;
              ...
              var V = parseInt(b, 10),
                ...
                w = parseInt(x, 10);
              if (!n(V, O, w)) return l;
              var A = new Date(V, O - 1, w);
              if (c) {
                var F = h.split(':');
                if (c.split(':').length !== F.length) return l;
                var C =
                    F.length > 0
                  ...
                  I =
                    F.length > 2
                      ? F[2].length <= 2 && /^\d+$/.test(F[2])
                        ...
                        : -1
                      : 0;
                if (-1 === C || -1 === _ || -1 === I) return l;
                if (I < 0 || I > 60) return l;
                if (C < 0 || C >= 24 || (u && C > 12)) return l;
                if (_ < 0 || _ > 59) return l;
                A.setHours(
                  m && 'PM' === m.toUpperCase() && C < 12 ? C + 12 : C,
                ),
                  A.setMinutes(_),
                  A.setSeconds(I);
              }
              var H = 'function' == typeof a.min ? a.min() : a.min,
                N = H instanceof Date ? H : H ? r(H, y, v) : A,
                S = 'function' == typeof a.max ? a.max() : a.max,
                P = S instanceof Date ? S : S ? r(S, y, v) : A,
                k = H instanceof Date ? o(N, a.format) : H,
                j = S instanceof Date ? o(P, a.format) : S;
              switch (!0) {
                case !!k && !j:
                  return {
                    message: t(e.l10n ? e.l10n.date.min : s, k),
                    meta: { date: A },
                    valid: A.getTime() >= N.getTime(),
                  };
                case !!j && !k:
                  return {
                    message: t(e.l10n ? e.l10n.date.max : s, j),
                    meta: { date: A },
                    valid: A.getTime() <= P.getTime(),
                  };
                case !!j && !!k:
                  return {
                    message: t(e.l10n ? e.l10n.date.range : s, [k, j]),
                    meta: { date: A },
                    valid:
                      A.getTime() <= P.getTime() && A.getTime() >= N.getTime(),
                  };
                default:
                  return {
                    message: ''.concat(s),
            ...
            validate: function (i) {
              ...
              if (!0 === r.multiple || 'true' === ''.concat(r.multiple)) {
                for (
                      ...
                      for (
                        ...
                        if (a % 2 == 0) {
                          ...
                          if (1 === l) o += s[0];
                            ...
                            r.push(o + s[0]);
                            for (var d = 1; d < l - 1; d++) r.push(s[d]);
                            o = s[l - 1];
                          }
                        } else (o += '"' + n[a]), a < i - 1 && (o += '"');
                      return r.push(o), r;
                  ...
                  if (!o.test(s[d])) return { valid: !1 };
                return { valid: !0 };
              }
              return { valid: o.test(i.value) };
            },
          };
        }),
        St
              ...
              if (window.File && window.FileList && window.FileReader) {
                ...
                for (var d = {}, c = 0; c < s; c++) {
                  if (
                    ((l += a[c].size),
                    (d = {
                      ext: (n = a[c].name.substr(
                        a[c].name.lastIndexOf('.') + 1,
                      )),
                      file: a[c],
                      size: a[c].size,
                      type: a[c].type,
                    ...
                    t.options.minSize &&
                      a[c].size < parseInt(''.concat(t.options.minSize), 10))
                  )
                    return {
                  ...
                  if (
                    t.options.maxSize &&
                    a[c].size > parseInt(''.concat(t.options.maxSize), 10)
                  )
                    return {
                  ...
                  if (
                    o.length > 0 &&
                    a[c].type &&
                    -1 === o.indexOf(a[c].type.toLowerCase())
                  )
                    return {
                  ...
                  if (
                    ...
                    !t.options.validateFileName(e(a[c].name))
                  )
                    return {
                ...
                if (
                  ((n = t.value.substr(t.value.lastIndexOf('.') + 1)),
                  r.length > 0 && -1 === r.indexOf(n.toLowerCase()))
                )
                  return {
                    meta: { error: 'INVALID_EXTENSION', ext: n },
                    valid: !1,
                  };
                if (
                  ((i = e(t.value)),
                  ...
                  return {
                    meta: { error: 'INVALID_NAME', name: i },
                    valid: !1,
                  };
              }
              return { valid: !0 };
            ...
            validate: function (e) {
              ...
              return i.inclusive
                ? {
                    message: t(
                      e.l10n
                        ? i.message || e.l10n.greaterThan.default
                        : i.message,
                      ''.concat(r),
                    ),
                ...
                : {
                    message: t(
                      e.l10n
                        ? i.message || e.l10n.greaterThan.notInclusive
                        : i.message,
                      ''.concat(r),
                    ),
                    valid: parseFloat(e.value) > r,
        ...
        (nn.integer = function () {
          return {
            validate: function (t) {
              ...
              r && (s = s.replace(a, '')), i && (s = s.replace(i, '.'));
              var l = parseFloat(s);
      ...
      return (
        (dn.ip = function () {
          return {
            validate: function (t) {
              if ('' === t.value) return { valid: !0 };
              var n = Object.assign({}, { ipv4: !0, ipv6: !0 }, e(t.options)),
                i =
          ...
          return {
            validate: function (e) {
              ...
              return i.inclusive
                ? {
                    message: t(
                      e.l10n ? i.message || e.l10n.lessThan.default : i.message,
                      ''.concat(r),
                    ),
                    valid: parseFloat(e.value) <= r,
                  }
                : {
                    message: t(
                      e.l10n
                        ? i.message || e.l10n.lessThan.notInclusive
                        : i.message,
                      ''.concat(r),
                    ),
                    valid: parseFloat(e.value) < r,
          ...
          return {
            validate: function (t) {
              ...
              var n = Object.assign(
                ...
                i = ''.concat(t.value);
              i.substr(0, 1) === n.decimalSeparator
                ? (i = '0'.concat(n.decimalSeparator).concat(i.substr(1)))
                : i.substr(0, 2) === '-'.concat(n.decimalSeparator) &&
                  (i = '-0'.concat(n.decimalSeparator).concat(i.substr(2)));
              var r = '.' === n.decimalSeparator ? '\\.' : n.decimalSeparator,
                ...
                s = new RegExp(o, 'g');
              if (!a.test(i)) return { valid: !1 };
              o && (i = i.replace(s, '')), r && (i = i.replace(r, '.'));
              var l = parseFloat(i);
  ...
  ? (Yn.exports = (function () {
      ...
      return (
        (qn.remote = function () {
          ...
          return {
            validate: function (i) {
              if ('' === i.value) return Promise.resolve({ valid: !0 });
...
'production' === process.env.NODE_ENV
  ? (Jn.exports = (function () {
      ...
      var e = a.utils.removeUndefined;
      return (
        (Kn.stringCase = function () {
          return {
            validate: function (t) {
              if ('' === t.value) return { valid: !0 };
              var n = Object.assign({}, { case: 'lower' }, e(t.options)),
          ...
          return {
            validate: function (e) {
              ...
              var o = i.min ? ''.concat(i.min) : '',
                ...
                l = !0,
                d = e.l10n
                  ? i.message || e.l10n.stringLength.default
                  : i.message;
              switch (
                (((o && s < parseInt(o, 10)) || (a && s > parseInt(a, 10))) &&
                  (l = !1),
                !0)
              ) {
                case !!o && !!a:
                  d = t(
                    e.l10n
                      ? i.message || e.l10n.stringLength.between
                      : i.message,
                    [o, a],
                  );
                  break;
                case !!o:
                  d = t(
                    e.l10n ? i.message || e.l10n.stringLength.more : i.message,
                    ''.concat(parseInt(o, 10)),
                  );
                  break;
                case !!a:
                  d = t(
                    e.l10n ? i.message || e.l10n.stringLength.less : i.message,
          ...
          return {
            validate: function (n) {
              ...
              var i = Object.assign({}, t, e(n.options)),
                ...
                o =
                  !0 === i.allowEmptyProtocol ||
                  'true' === ''.concat(i.allowEmptyProtocol),
...
var fi = li.exports,
  pi = {
    Alias: f.Alias,
    Aria: y.Aria,
    Declarative: w.Declarative,
    DefaultSubmit: H.DefaultSubmit,
    ...
    Icon: fe.Icon,
    Message: ne.Message,
    Sequence: ye.Sequence,
    SubmitButton: we.SubmitButton,
    Tooltip: He.Tooltip,
    Trigger: Le.Trigger,
  },
  hi = {
    ...
    date: yt.date,
    different: wt.different,
    digits: Ht.digits,
    emailAddress: Lt.emailAddress,
    file: Ut.file,
    greaterThan: $t.greaterThan,
    identical: en.identical,
    integer: sn.integer,
    ip: pn.ip,
    lessThan: bn.lessThan,
    notEmpty: An.notEmpty,
    numeric: Nn.numeric,
    promise: Dn.promise,
    regexp: Bn.regexp,
    remote: Xn.remote,
    stringCase: ti.stringCase,
    stringLength: si.stringLength,
    uri: fi.uri,
  };
(exports.Plugin = a.Plugin),
  (exports.algorithms = a.algorithms),
  (exports.formValidation = function (e, t) {
    var n = a.formValidation(e, t);
    return (
      Object.keys(hi).forEach(function (e) {
        return n.registerValidator(e, hi[e]);
      }),
      n
    );
  }),
  (exports.plugins = pi),
  (exports.utils = a.utils),
  (exports.validators = hi);
