...
var a = (function (t) {
  function a(e) {
    ...
    return (
      ...
      (a.validatePassword = a.checkPasswordStrength.bind(a)),
  ...
  return (
    ...
    (a.prototype.onEnabled = function () {
      this.core.enableValidator(this.opts.field, a.PASSWORD_STRENGTH_VALIDATOR);
    }),
    ...
    (a.prototype.checkPasswordStrength = function () {
      ...
      return {
        validate: function (e) {
          ...
          var o = zxcvbn(a),
            i = o.score,
            r = o.feedback.warning || 'The password is weak';
